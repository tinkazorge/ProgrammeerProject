package org.andengine.entity.sprite.batch.vbo.andengine.util.adt.array;
...
public final class ArrayUtils {
	...
	public static <T> T[] join(final Class<T[]> pClass, final T[]... pArrays) {
		...
		/* Determine length of result. */
		final T[] result = org.andengine.util.adt.array.ArrayUtils.newArray(pClass, resultLength);
		int offset = 0;
	...
	public static int idealBooleanArraySize(final int pSize) {
		return org.andengine.util.adt.array.ArrayUtils.idealByteArraySize(pSize);
	}

	public static int idealShortArraySize(final int pSize) {
		return org.andengine.util.adt.array.ArrayUtils.idealByteArraySize(pSize << 1) >> 1;
	}
	...
	public static int idealIntArraySize(final int pSize) {
		return org.andengine.util.adt.array.ArrayUtils.idealByteArraySize(pSize << 2) >> 2;
	}
	...
	public static int idealDoubleArraySize(final int pSize) {
		return org.andengine.util.adt.array.ArrayUtils.idealByteArraySize(pSize << 3) >> 3;
	}
	...
	public static final float average(final float[] pValues) {
		return org.andengine.util.adt.array.ArrayUtils.sum(pValues) / pValues.length;
	}
	...
	public static <T> T[] filter(final T[] pArray, final Class<T[]> pClass, final IMatcher<T> pMatcher) {
		...
		final T[] filteredArray = org.andengine.util.adt.array.ArrayUtils.newArray(pClass, filteredArrayLength);
		int resultIndex = 0;
