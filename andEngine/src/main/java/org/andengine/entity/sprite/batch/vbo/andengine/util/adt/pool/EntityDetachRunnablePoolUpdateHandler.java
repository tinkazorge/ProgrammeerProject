 ...
 */
public class EntityDetachRunnablePoolUpdateHandler extends RunnablePoolUpdateHandler<org.andengine.util.adt.pool.EntityDetachRunnablePoolItem> {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	@Override
	protected org.andengine.util.adt.pool.EntityDetachRunnablePoolItem onAllocatePoolItem() {
		return new org.andengine.util.adt.pool.EntityDetachRunnablePoolItem();
	}
