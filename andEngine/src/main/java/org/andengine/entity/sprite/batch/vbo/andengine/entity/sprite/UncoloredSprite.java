...
public class UncoloredSprite extends Sprite {
	...
	public static final int VERTEX_INDEX_Y = org.andengine.entity.sprite.UncoloredSprite.VERTEX_INDEX_X + 1;
	public static final int TEXTURECOORDINATES_INDEX_U = org.andengine.entity.sprite.UncoloredSprite.VERTEX_INDEX_Y + 1;
	public static final int TEXTURECOORDINATES_INDEX_V = org.andengine.entity.sprite.UncoloredSprite.TEXTURECOORDINATES_INDEX_U + 1;

	public static final int VERTEX_SIZE = 2 + 2;
	public static final int VERTICES_PER_SPRITE = 4;
	public static final int SPRITE_SIZE = org.andengine.entity.sprite.UncoloredSprite.VERTEX_SIZE * org.andengine.entity.sprite.UncoloredSprite.VERTICES_PER_SPRITE;
	...
	public UncoloredSprite(final float pX, final float pY, final float pWidth, final float pHeight, final ITextureRegion pTextureRegion, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX, pY, pWidth, pHeight, pTextureRegion, new HighPerformanceUncoloredSpriteVertexBufferObject(pVertexBufferObjectManager, org.andengine.entity.sprite.UncoloredSprite.SPRITE_SIZE, pDrawType, true, org.andengine.entity.sprite.UncoloredSprite.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
	...
	public UncoloredSprite(final float pX, final float pY, final float pWidth, final float pHeight, final ITextureRegion pTextureRegion, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType, final ShaderProgram pShaderProgram) {
		this(pX, pY, pWidth, pHeight, pTextureRegion, new HighPerformanceUncoloredSpriteVertexBufferObject(pVertexBufferObjectManager, org.andengine.entity.sprite.UncoloredSprite.SPRITE_SIZE, pDrawType, true, org.andengine.entity.sprite.UncoloredSprite.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT), pShaderProgram);
	}
