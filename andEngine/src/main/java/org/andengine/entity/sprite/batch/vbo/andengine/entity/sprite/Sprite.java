...
public class Sprite extends Shape {
	...
	public static final int VERTEX_INDEX_Y = org.andengine.entity.sprite.Sprite.VERTEX_INDEX_X + 1;
	public static final int COLOR_INDEX = org.andengine.entity.sprite.Sprite.VERTEX_INDEX_Y + 1;
	public static final int TEXTURECOORDINATES_INDEX_U = org.andengine.entity.sprite.Sprite.COLOR_INDEX + 1;
	public static final int TEXTURECOORDINATES_INDEX_V = org.andengine.entity.sprite.Sprite.TEXTURECOORDINATES_INDEX_U + 1;

	public static final int VERTEX_SIZE = 2 + 1 + 2;
	public static final int VERTICES_PER_SPRITE = 4;
	public static final int SPRITE_SIZE = org.andengine.entity.sprite.Sprite.VERTEX_SIZE * org.andengine.entity.sprite.Sprite.VERTICES_PER_SPRITE;
	...
	public Sprite(final float pX, final float pY, final float pWidth, final float pHeight, final ITextureRegion pTextureRegion, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType, final ShaderProgram pShaderProgram) {
		this(pX, pY, pWidth, pHeight, pTextureRegion, new HighPerformanceSpriteVertexBufferObject(pVertexBufferObjectManager, org.andengine.entity.sprite.Sprite.SPRITE_SIZE, pDrawType, true, org.andengine.entity.sprite.Sprite.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT), pShaderProgram);
	}
	...
	protected void draw(final GLState pGLState, final Camera pCamera) {
		this.mSpriteVertexBufferObject.draw(GLES20.GL_TRIANGLE_STRIP, org.andengine.entity.sprite.Sprite.VERTICES_PER_SPRITE);
	}
