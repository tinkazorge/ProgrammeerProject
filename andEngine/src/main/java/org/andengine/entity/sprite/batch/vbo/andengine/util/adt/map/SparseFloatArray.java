...
public class SparseFloatArray implements Cloneable {
    ...
    @Override
    public org.andengine.util.adt.map.SparseFloatArray clone() {
        org.andengine.util.adt.map.SparseFloatArray clone = null;
        try {
            clone = (org.andengine.util.adt.map.SparseFloatArray) super.clone();
