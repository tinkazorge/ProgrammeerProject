package org.andengine.entity.sprite.batch.vbo.andengine.entity.shape;
 ...
 */
public abstract class Shape extends Entity implements org.andengine.entity.shape.IShape {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	protected int mBlendFunctionSource = org.andengine.entity.shape.IShape.BLENDFUNCTION_SOURCE_DEFAULT;
	protected int mBlendFunctionDestination = org.andengine.entity.shape.IShape.BLENDFUNCTION_DESTINATION_DEFAULT;
	...
	public void reset() {
		...
		this.mBlendFunctionSource = org.andengine.entity.shape.IShape.BLENDFUNCTION_SOURCE_DEFAULT;
		this.mBlendFunctionDestination = org.andengine.entity.shape.IShape.BLENDFUNCTION_DESTINATION_DEFAULT;
	}
	...
	protected void initBlendFunction(final TextureOptions pTextureOptions) {
		if (pTextureOptions.mPreMultiplyAlpha) {
			this.setBlendFunction(org.andengine.entity.shape.IShape.BLENDFUNCTION_SOURCE_PREMULTIPLYALPHA_DEFAULT, IShape.BLENDFUNCTION_DESTINATION_PREMULTIPLYALPHA_DEFAULT);
		}
	}
