package org.andengine.entity.sprite.batch.vbo.andengine.util.math;
...
public final class MathUtils {
	...
	public static final float random(final float pMin, final float pMax) {
		return pMin + (org.andengine.util.math.MathUtils.RANDOM.nextFloat() * (pMax - pMin));
	}
	...
	public static final int random(final int pMin, final int pMax) {
		return pMin + org.andengine.util.math.MathUtils.RANDOM.nextInt((pMax - pMin) + 1);
	}
	...
	public static final int random(final int pMax) {
		return org.andengine.util.math.MathUtils.RANDOM.nextInt(pMax);
	}
	...
	public static final int nextPowerOfTwo(final float f) {
		return org.andengine.util.math.MathUtils.nextPowerOfTwo((int) (Math.ceil(f)));
	}
	...
	public static float[] rotateAroundCenter(final float[] pVertices, final float pRotation, final float pRotationCenterX, final float pRotationCenterY) {
		if (pRotation != 0) {
			final float rotationRad = org.andengine.util.math.MathUtils.degToRad(pRotation);
	...
	public static float[] rotateAndScaleAroundCenter(final float[] pVertices, final float pRotation, final float pRotationCenterX, final float pRotationCenterY, final float pScaleX, final float pScaleY, final float pScaleCenterX, final float pScaleCenterY) {
		org.andengine.util.math.MathUtils.rotateAroundCenter(pVertices, pRotation, pRotationCenterX, pRotationCenterY);
		return org.andengine.util.math.MathUtils.scaleAroundCenter(pVertices, pScaleX, pScaleY, pScaleCenterX, pScaleCenterY);
	}
	...
	public static float[] revertScaleAroundCenter(final float[] pVertices, final float pScaleX, final float pScaleY, final float pScaleCenterX, final float pScaleCenterY) {
		return org.andengine.util.math.MathUtils.scaleAroundCenter(pVertices, 1 / pScaleX, 1 / pScaleY, pScaleCenterX, pScaleCenterY);
	}
	...
	public static float[] revertRotateAroundCenter(final float[] pVertices, final float pRotation, final float pRotationCenterX, final float pRotationCenterY) {
		return org.andengine.util.math.MathUtils.rotateAroundCenter(pVertices, -pRotation, pRotationCenterX, pRotationCenterY);
	}
	...
	public static float[] revertRotateAndScaleAroundCenter(final float[] pVertices, final float pRotation, final float pRotationCenterX, final float pRotationCenterY, final float pScaleX, final float pScaleY, final float pScaleCenterX, final float pScaleCenterY) {
		org.andengine.util.math.MathUtils.revertScaleAroundCenter(pVertices, pScaleX, pScaleY, pScaleCenterX, pScaleCenterY);
		return org.andengine.util.math.MathUtils.revertRotateAroundCenter(pVertices, pRotation, pRotationCenterX, pRotationCenterY);
	}
