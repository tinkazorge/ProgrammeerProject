package org.andengine.entity.sprite.batch.vbo.andengine.opengl.vbo.attribute;

import org.andengine.opengl.vbo.attribute.*;
...
public class VertexBufferObjectAttributesBuilder {
	...
	public org.andengine.opengl.vbo.attribute.VertexBufferObjectAttributesBuilder add(final int pLocation, final String pName, final int pSize, final int pType, final boolean pNormalized) {
		if (org.andengine.opengl.vbo.attribute.VertexBufferObjectAttributesBuilder.WORAROUND_GLES2_GLVERTEXATTRIBPOINTER_MISSING) {
