package org.andengine.entity.sprite.batch.vbo.andengine.opengl.texture.atlas;
...
public interface ITextureAtlas<T extends ITextureAtlasSource> extends ITexture {
	...
	public static interface ITextureAtlasStateListener<T extends ITextureAtlasSource> extends ITextureStateListener {
		...
		public void onTextureAtlasSourceLoaded(final org.andengine.opengl.texture.atlas.ITextureAtlas<T> pTextureAtlas, final T pTextureAtlasSource);
		public void onTextureAtlasSourceLoadExeption(final org.andengine.opengl.texture.atlas.ITextureAtlas<T> pTextureAtlas, final T pTextureAtlasSource, final Throwable pThrowable);
