...
public class EaseCircularInOut implements IEaseFunction {
	...
	private static org.andengine.util.modifier.ease.EaseCircularInOut INSTANCE;
	...
	public static org.andengine.util.modifier.ease.EaseCircularInOut getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new org.andengine.util.modifier.ease.EaseCircularInOut();
		}
		return INSTANCE;
	}
