...
public abstract class VertexBufferObject implements IVertexBufferObject {
	...
	protected final org.andengine.opengl.vbo.VertexBufferObjectManager mVertexBufferObjectManager;
	 ...
	 * @param pCapacity
	 * @param pDrawType
	 * @param pAutoDispose when passing <code>true</code> this {@link org.andengine.opengl.vbo.VertexBufferObject} loads itself to the active {@link org.andengine.opengl.vbo.VertexBufferObjectManager}. <b><u>WARNING:</u></b> When passing <code>false</code> one needs to take care of that by oneself!
	 ...
	 */
	public VertexBufferObject(final org.andengine.opengl.vbo.VertexBufferObjectManager pVertexBufferObjectManager, final int pCapacity, final DrawType pDrawType, final boolean pAutoDispose, final VertexBufferObjectAttributes pVertexBufferObjectAttributes) {
