...
import org.andengine.opengl.util.GLScissorStack;
...
public class GLState {
	...
	private final org.andengine.opengl.util.GLScissorStack mScissorStack = new GLScissorStack();
	...
	public void reset(final RenderOptions pRenderOptions, final ConfigChooser pConfigChooser, final EGLConfig pEGLConfig) {
		...
		this.lineWidth(org.andengine.opengl.util.GLState.LINE_WIDTH_DEFAULT);
