...
public class JumpModifier extends MoveModifier {
	...
	public JumpModifier(final float pDuration, final float pFromX, final float pToX, final float pFromY, final float pToY, final float pJumpHeight) {
		this(pDuration, pFromX, pToX, pFromY, pToY, pJumpHeight, org.andengine.entity.modifier.JumpModifier.JUMPCOUNT_DEFAULT, EaseLinear.getInstance());
	}
	...
	public JumpModifier(final float pDuration, final float pFromX, final float pToX, final float pFromY, final float pToY, final float pJumpHeight, final IEaseFunction pEaseFunction) {
		this(pDuration, pFromX, pToX, pFromY, pToY, pJumpHeight, org.andengine.entity.modifier.JumpModifier.JUMPCOUNT_DEFAULT, pEaseFunction);
	}
	...
	public JumpModifier(final float pDuration, final float pFromX, final float pToX, final float pFromY, final float pToY, final float pJumpHeight, final IEntityModifierListener pEntityModifierListener) {
		this(pDuration, pFromX, pToX, pFromY, pToY, pJumpHeight, org.andengine.entity.modifier.JumpModifier.JUMPCOUNT_DEFAULT, pEntityModifierListener, EaseLinear.getInstance());
	}
	...
	public JumpModifier(final float pDuration, final float pFromX, final float pToX, final float pFromY, final float pToY, final float pJumpHeight, final IEntityModifierListener pEntityModifierListener, final IEaseFunction pEaseFunction) {
		this(pDuration, pFromX, pToX, pFromY, pToY, pJumpHeight, org.andengine.entity.modifier.JumpModifier.JUMPCOUNT_DEFAULT, pEntityModifierListener, pEaseFunction);
	}
	...
	public JumpModifier(final org.andengine.entity.modifier.JumpModifier pJumpModifier) {
		super(pJumpModifier);
	...
	@Override
	public org.andengine.entity.modifier.JumpModifier deepCopy() throws DeepCopyNotSupportedException {
		return new org.andengine.entity.modifier.JumpModifier(this);
	}
