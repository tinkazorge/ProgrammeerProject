...
public abstract class LineChain extends Shape {
	...
	public static final int VERTEX_INDEX_Y = org.andengine.entity.primitive.LineChain.VERTEX_INDEX_X + 1;
	public static final int COLOR_INDEX = org.andengine.entity.primitive.LineChain.VERTEX_INDEX_Y + 1;
	...
	public LineChain(final float pX, final float pY, final int pCapacity, final VertexBufferObjectManager pVertexBufferObjectManager) {
		this(pX, pY, org.andengine.entity.primitive.LineChain.LINE_WIDTH_DEFAULT, pCapacity, pVertexBufferObjectManager, DrawType.STATIC);
	}
	...
	public LineChain(final float pX, final float pY, final int pCapacity, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX, pY, org.andengine.entity.primitive.LineChain.LINE_WIDTH_DEFAULT, pCapacity, pVertexBufferObjectManager, pDrawType);
	}
	...
	public LineChain(final float pX, final float pY, final float pLineWidth, final int pCapacity, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX, pY, pLineWidth, pCapacity, new HighPerformanceLineChainVertexBufferObject(pVertexBufferObjectManager, pCapacity * org.andengine.entity.primitive.LineChain.VERTEX_SIZE, pDrawType, true, org.andengine.entity.primitive.LineChain.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
