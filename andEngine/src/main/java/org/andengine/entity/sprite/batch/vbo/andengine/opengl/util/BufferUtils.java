...
public class BufferUtils {
	...
	static {
		...
		if (org.andengine.opengl.util.BufferUtils.NATIVE_LIB_LOADED) {
	...
	public static ByteBuffer allocateDirectByteBuffer(final int pCapacity) {
		if (org.andengine.opengl.util.BufferUtils.WORKAROUND_BYTEBUFFER_ALLOCATE_DIRECT) {
			return org.andengine.opengl.util.BufferUtils.jniAllocateDirect(pCapacity);
		} else {
	...
	public static void freeDirectByteBuffer(final ByteBuffer pByteBuffer) {
		if (org.andengine.opengl.util.BufferUtils.WORKAROUND_BYTEBUFFER_ALLOCATE_DIRECT) {
			org.andengine.opengl.util.BufferUtils.jniFreeDirect(pByteBuffer);
		}
	}
	...
	public static void put(final ByteBuffer pByteBuffer, final float[] pSource, final int pLength, final int pOffset) {
		if (org.andengine.opengl.util.BufferUtils.WORKAROUND_BYTEBUFFER_PUT_FLOATARRAY) {
			org.andengine.opengl.util.BufferUtils.jniPut(pByteBuffer, pSource, pLength, pOffset);
		} else {
