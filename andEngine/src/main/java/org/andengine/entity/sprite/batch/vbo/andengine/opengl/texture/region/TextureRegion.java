...
public class TextureRegion extends BaseTextureRegion {
	...
	@Override
	public org.andengine.opengl.texture.region.TextureRegion deepCopy() {
		if (this.mRotated) {
			return new org.andengine.opengl.texture.region.TextureRegion(this.mTexture, this.mTextureX, this.mTextureY, this.mTextureHeight, this.mTextureWidth, this.mScale, this.mRotated);
		} else {
			return new org.andengine.opengl.texture.region.TextureRegion(this.mTexture, this.mTextureX, this.mTextureY, this.mTextureWidth, this.mTextureHeight, this.mScale, this.mRotated);
		}
	}
