...
public class ColorBackgroundModifier extends BaseTripleValueSpanModifier<IBackground> implements IBackgroundModifier {
	...
	protected ColorBackgroundModifier(final org.andengine.entity.scene.background.modifier.ColorBackgroundModifier pColorBackgroundModifier) {
		super(pColorBackgroundModifier);
	}

	@Override
	public org.andengine.entity.scene.background.modifier.ColorBackgroundModifier deepCopy() {
		return new org.andengine.entity.scene.background.modifier.ColorBackgroundModifier(this);
	}
