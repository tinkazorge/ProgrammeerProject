...
import org.andengine.util.IntentUtils;
...
public final class GooglePlayUtils {
	...
	public static void startGooglePlayActivity(final Context pContext) {
		org.andengine.util.GooglePlayUtils.startGooglePlayActivity(pContext, SystemUtils.getPackageName(pContext));
	}
	...
	public static void startGooglePlayActivity(final Context pContext, final String pPackageName) {
		...
		if (org.andengine.util.IntentUtils.isIntentResolvable(pContext, googlePlayAppIntent)) {
	...
	public static void startGooglePlayActivityForResult(final Activity pActivity, final int pRequestCode) {
		org.andengine.util.GooglePlayUtils.startGooglePlayActivityForResult(pActivity, SystemUtils.getPackageName(pActivity), pRequestCode);
	}
