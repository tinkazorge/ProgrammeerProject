...
public class SequenceModifier<T> extends BaseModifier<T> implements IModifierListener<T> {
	...
	protected SequenceModifier(final org.andengine.util.modifier.SequenceModifier<T> pSequenceModifier) throws DeepCopyNotSupportedException {
	...
	@Override
	public org.andengine.util.modifier.SequenceModifier<T> deepCopy() throws DeepCopyNotSupportedException {
		return new org.andengine.util.modifier.SequenceModifier<T>(this);
	}
