package org.andengine.entity.sprite.batch.vbo.andengine.util.system;
...
public final class SystemUtils {
	...
	public static MemoryInfo getMemoryInfo() {
		/* Lazy allocation. */
		if (org.andengine.util.system.SystemUtils.sMemoryInfo == null) {
			org.andengine.util.system.SystemUtils.sMemoryInfo = new MemoryInfo();
		}

		Debug.getMemoryInfo(org.andengine.util.system.SystemUtils.sMemoryInfo);

		return org.andengine.util.system.SystemUtils.sMemoryInfo;
	}

	public static boolean isGoogleTV(final Context pContext) throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.hasSystemFeature(pContext, "com.google.android.tv");
	}

	public static boolean isGoogleTV(final Context pContext, final boolean pDefault) {
		try {
			return org.andengine.util.system.SystemUtils.isGoogleTV(pContext);
	...
	public static boolean hasCamera(final Context pContext) throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.hasSystemFeature(pContext, PackageManager.FEATURE_CAMERA);
	}

	public static boolean hasCamera(final Context pContext, final boolean pDefault) {
		try {
			return org.andengine.util.system.SystemUtils.hasCamera(pContext);
		} catch (final SystemUtilsException e) {
			return pDefault;
		}
	}
	...
	public static boolean isNDKSupported(final Context pContext, final boolean pDefault) {
		try {
			if (org.andengine.util.system.SystemUtils.isGoogleTV(pContext)) {
				if (org.andengine.util.system.SystemUtils.isAndroidVersionOrHigher(Build.VERSION_CODES.JELLY_BEAN_MR1)) {
					return true;
				} else {
					return false;
				}
	...
	public static String getApplicationLabel(final Context pContext) throws SystemUtilsException {
	    final int labelResID = org.andengine.util.system.SystemUtils.getApplicationInfo(pContext).labelRes;
	...
	public static int getPackageVersionCode(final Context pContext) throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.getPackageInfo(pContext).versionCode;
	}

	public static String getPackageVersionName(final Context pContext) throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.getPackageInfo(pContext).versionName;
	}
	...
	public static String getApkFilePath(final Context pContext) throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.getApplicationInfo(pContext, 0).sourceDir;
	}

	public static ApplicationInfo getApplicationInfo(final Context pContext) throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.getApplicationInfo(pContext, 0);
	}
	...
	public static PackageInfo getPackageInfo(final Context pContext) throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.getPackageInfo(pContext, 0);
	}
	...
	public static int getTargetSDKVersion(final Context pContext) throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.getApplicationInfo(pContext).targetSdkVersion;
	}
	...
	public static boolean hasSystemFeature(final Context pContext, final String pFeature, final boolean pDefault) {
		try {
			return org.andengine.util.system.SystemUtils.hasSystemFeature(pContext, pFeature);
		} catch (final SystemUtilsException e) {
			return pDefault;
		}
	}
	...
	public static boolean optMetaDataBoolean(final Context pContext, final String pKey) throws SystemUtilsException {
		final Bundle bundle = org.andengine.util.system.SystemUtils.getMetaData(pContext);
	...
	public static Bundle getMetaData(final Context pContext) throws SystemUtilsException {
		try {
			final ApplicationInfo applicationInfo = org.andengine.util.system.SystemUtils.getApplicationInfo(pContext, PackageManager.GET_META_DATA);
	...
	public static float getCPUBogoMips() throws SystemUtilsException {
		final MatchResult matchResult = org.andengine.util.system.SystemUtils.matchSystemFile("/proc/cpuinfo", org.andengine.util.system.SystemUtils.BOGOMIPS_PATTERN, 1000);
	...
	public static long getSystemMemorySize() throws SystemUtilsException {
		final MatchResult matchResult = org.andengine.util.system.SystemUtils.matchSystemFile("/proc/meminfo", org.andengine.util.system.SystemUtils.MEMTOTAL_PATTERN, 1000);
	...
	public static long getSystemMemoryFreeSize() throws SystemUtilsException {
		final MatchResult matchResult = org.andengine.util.system.SystemUtils.matchSystemFile("/proc/meminfo", org.andengine.util.system.SystemUtils.MEMFREE_PATTERN, 1000);
	...
	public static long getCPUFrequencyCurrent() throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.readSystemFileAsLong("/sys/devices/system/cpu/cpu0/cpufreq/scaling_cur_freq");
	}
	...
	public static long getCPUFrequencyMin() throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.readSystemFileAsLong("/sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_min_freq");
	}
	...
	public static long getCPUFrequencyMax() throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.readSystemFileAsLong("/sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_max_freq");
	}
	...
	public static long getCPUFrequencyMinScaling() throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.readSystemFileAsLong("/sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq");
	}
	...
	public static long getCPUFrequencyMaxScaling() throws SystemUtilsException {
		return org.andengine.util.system.SystemUtils.readSystemFileAsLong("/sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq");
	}
	...
	public static long getDalvikHeapAllocatedSize() {
		return org.andengine.util.system.SystemUtils.getDalvikHeapSize() - org.andengine.util.system.SystemUtils.getDalvikHeapFreeSize();
	}

	public static long getNativeProportionalSetSize() {
		return org.andengine.util.system.SystemUtils.getMemoryInfo().nativePss;
	}

	public static long getNativePrivateDirtyPages() {
		return org.andengine.util.system.SystemUtils.getMemoryInfo().nativePrivateDirty;
	}

	public static long getNativeSharedDirtyPages() {
		return org.andengine.util.system.SystemUtils.getMemoryInfo().nativeSharedDirty;
	}

	public static long getDalvikProportionalSetSize() {
		return org.andengine.util.system.SystemUtils.getMemoryInfo().dalvikPss;
	}

	public static long getDalvikPrivateDirtyPages() {
		return org.andengine.util.system.SystemUtils.getMemoryInfo().dalvikPrivateDirty;
	}

	public static long getDalvikSharedDirtyPages() {
		return org.andengine.util.system.SystemUtils.getMemoryInfo().dalvikSharedDirty;
	}

	public static long getOtherProportionalSetSize() {
		return org.andengine.util.system.SystemUtils.getMemoryInfo().otherPss;
	}

	public static long getOtherPrivateDirtyPages() {
		return org.andengine.util.system.SystemUtils.getMemoryInfo().otherPrivateDirty;
	}

	public static long getOtherSharedDirtyPages() {
		return org.andengine.util.system.SystemUtils.getMemoryInfo().otherSharedDirty;
	}
