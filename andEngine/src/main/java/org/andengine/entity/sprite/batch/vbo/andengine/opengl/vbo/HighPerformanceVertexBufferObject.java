...
/**
 * Compared to a {@link LowMemoryVertexBufferObject}, the {@link org.andengine.opengl.vbo.HighPerformanceVertexBufferObject} uses <b><u>2x</u> the heap memory</b>,
 * at the benefit of significantly faster data buffering (<b>up to <u>5x</u> faster!</b>).
 *
 * @see {@link LowMemoryVertexBufferObject} when to prefer a {@link LowMemoryVertexBufferObject} instead of a {@link org.andengine.opengl.vbo.HighPerformanceVertexBufferObject}
 *
