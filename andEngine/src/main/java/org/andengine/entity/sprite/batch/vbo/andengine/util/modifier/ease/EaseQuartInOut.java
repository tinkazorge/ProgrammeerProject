...
public class EaseQuartInOut implements IEaseFunction {
	...
	private static org.andengine.util.modifier.ease.EaseQuartInOut INSTANCE;
	...
	public static org.andengine.util.modifier.ease.EaseQuartInOut getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new org.andengine.util.modifier.ease.EaseQuartInOut();
		}
		return INSTANCE;
	}
