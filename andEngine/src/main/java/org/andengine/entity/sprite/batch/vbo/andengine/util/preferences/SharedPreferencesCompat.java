...
public class SharedPreferencesCompat {
	...
	public static void apply(final Editor pEditor) {
		if (org.andengine.util.preferences.SharedPreferencesCompat.WORKAROUND_APPLY_METHOD != null) {
			try {
				org.andengine.util.preferences.SharedPreferencesCompat.WORKAROUND_APPLY_METHOD.invoke(pEditor);
				return;
