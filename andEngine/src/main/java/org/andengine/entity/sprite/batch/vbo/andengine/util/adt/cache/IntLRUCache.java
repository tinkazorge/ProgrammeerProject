package org.andengine.entity.sprite.batch.vbo.andengine.util.adt.cache;
...
public class IntLRUCache<V> {
	...
	private final GenericPool<IntLRUCacheValueHolder<V>> mIntLRUCacheValueHolderPool = new GenericPool<org.andengine.util.adt.cache.IntLRUCache.IntLRUCacheValueHolder<V>>() {
		@Override
...
//		final IntLRUCacheValueHolder<V> intLRUCacheValueHolder = new IntLRUCacheValueHolder<V>();
	...
	static class IntLRUCacheQueue {
		...
		private final GenericPool<IntLRUCacheQueueNode> mIntLRUCacheQueueNodePool = new GenericPool<org.andengine.util.adt.cache.IntLRUCache.IntLRUCacheQueueNode>() {
			@Override
