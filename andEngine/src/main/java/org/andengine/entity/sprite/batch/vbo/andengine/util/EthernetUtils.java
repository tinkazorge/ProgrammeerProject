...
public final class EthernetUtils {
	...
	public static String getEthernetIPAddress() throws EthernetUtilsException {
		try {
			return IPUtils.ipAddressToString(org.andengine.util.EthernetUtils.getEthernetIPAddressRaw());
	...
	public static boolean getEthernetIPAddressValid() throws EthernetUtilsException { // TODO!
		return !org.andengine.util.EthernetUtils.IP_DEFAULT.equals(org.andengine.util.EthernetUtils.getEthernetIPAddress());
	}
