...
public class AlphaMenuSceneAnimator extends MenuSceneAnimator {
	...
	public AlphaMenuSceneAnimator() {
		this(org.andengine.entity.scene.menu.animator.AlphaMenuSceneAnimator.EASEFUNCTION_DEFAULT);
	}
	...
	public AlphaMenuSceneAnimator(final HorizontalAlign pHorizontalAlign, final VerticalAlign pVerticalAlign) {
		this(pHorizontalAlign, pVerticalAlign, org.andengine.entity.scene.menu.animator.AlphaMenuSceneAnimator.EASEFUNCTION_DEFAULT);
	}
	...
	protected void onMenuItemPositionBuilt(final MenuScene pMenuScene, final int pIndex, final IMenuItem pMenuItem, final float pX, final float pY) {
		...
		final AlphaModifier alphaModifier = new AlphaModifier(org.andengine.entity.scene.menu.animator.AlphaMenuSceneAnimator.DURATION, org.andengine.entity.scene.menu.animator.AlphaMenuSceneAnimator.ALPHA_FROM, org.andengine.entity.scene.menu.animator.AlphaMenuSceneAnimator.ALPHA_TO, this.mEaseFunction);
	...
	protected void onMenuItemPositionReset(final MenuScene pMenuScene, final int pIndex, final IMenuItem pMenuItem, final float pX, final float pY) {
		...
		pMenuItem.setAlpha(org.andengine.entity.scene.menu.animator.AlphaMenuSceneAnimator.ALPHA_FROM);
	}
