...
public class ScrollDetector extends BaseDetector {
	...
	public ScrollDetector(final IScrollDetectorListener pScrollDetectorListener) {
		this(org.andengine.input.touch.detector.ScrollDetector.TRIGGER_SCROLL_MINIMUM_DISTANCE_DEFAULT, pScrollDetectorListener);
	}
	...
	public static interface IScrollDetectorListener {
		...
		public void onScrollStarted(final org.andengine.input.touch.detector.ScrollDetector pScollDetector, final int pPointerID, final float pDistanceX, final float pDistanceY);
		public void onScroll(final org.andengine.input.touch.detector.ScrollDetector pScollDetector, final int pPointerID, final float pDistanceX, final float pDistanceY);
		public void onScrollFinished(final org.andengine.input.touch.detector.ScrollDetector pScollDetector, final int pPointerID, final float pDistanceX, final float pDistanceY);
	}
}
