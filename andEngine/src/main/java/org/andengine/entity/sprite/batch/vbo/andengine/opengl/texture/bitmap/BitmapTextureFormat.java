package org.andengine.entity.sprite.batch.vbo.andengine.opengl.texture.bitmap;
...
public enum BitmapTextureFormat {
	...
	public static org.andengine.opengl.texture.bitmap.BitmapTextureFormat fromPixelFormat(final PixelFormat pPixelFormat) {
		switch (pPixelFormat) {
			case RGBA_8888:
				return RGBA_8888;
			case RGBA_4444:
