...
public interface IEntity extends IDrawHandler, IUpdateHandler, IDisposable, ITouchArea {
	...
	public org.andengine.entity.IEntity getParent();
	public void setParent(final org.andengine.entity.IEntity pEntity);

	public org.andengine.entity.IEntity getRootEntity();
	...
	public void setPosition(final org.andengine.entity.IEntity pOtherEntity);
	...
	public void attachChild(final org.andengine.entity.IEntity pEntity);

	public org.andengine.entity.IEntity getChildByTag(final int pTag);
	public org.andengine.entity.IEntity getChildByMatcher(final IEntityMatcher pEntityMatcher);
	public org.andengine.entity.IEntity getChildByIndex(final int pIndex);
	public org.andengine.entity.IEntity getFirstChild();
	public org.andengine.entity.IEntity getLastChild();

	/**
	 * @param pEntityMatcher
	 * @return all children (recursively!) that match the supplied {@link IEntityMatcher}.
	 */
	public ArrayList<org.andengine.entity.IEntity> query(final IEntityMatcher pEntityMatcher);
	/**
	 * @param pEntityMatcher
	 * @return the first child (recursively!) that matches the supplied {@link IEntityMatcher} or <code>null</code> if none matches..
	 */
	public org.andengine.entity.IEntity queryFirst(final IEntityMatcher pEntityMatcher);
	/**
	 * @param pEntityMatcher
	 * @param pResult the {@link List} to put the result into.
	 * @return all children (recursively!) that match the supplied {@link IEntityMatcher}.
	 */
	public <L extends List<org.andengine.entity.IEntity>> L query(final IEntityMatcher pEntityMatcher, final L pResult);
	/**
	 * @param pEntityMatcher
	 * @return the first child (recursively!) that matches the supplied {@link IEntityMatcher} or <code>null</code> if none matches..
	 ...
	 */
	public <S extends org.andengine.entity.IEntity> S queryFirstForSubclass(final IEntityMatcher pEntityMatcher);
	/**
	 * @param pEntityMatcher
	 * @return all children (recursively!) that match the supplied {@link IEntityMatcher}.
	 * @throws ClassCastException when the supplied {@link IEntityMatcher} matched an {@link org.andengine.entity.IEntity} that was not of the requested subtype.
	 */
	public <S extends org.andengine.entity.IEntity> ArrayList<S> queryForSubclass(final IEntityMatcher pEntityMatcher) throws ClassCastException;
	/**
	 * @param pEntityMatcher
	 * @param pResult the {@link List} to put the result into.
	 * @return all children (recursively!) that match the supplied {@link IEntityMatcher}.
	 * @throws ClassCastException when the supplied {@link IEntityMatcher} matched an {@link org.andengine.entity.IEntity} that was not of the requested subtype.
	 */
	public <L extends List<S>, S extends org.andengine.entity.IEntity> L queryForSubclass(final IEntityMatcher pEntityMatcher, final L pResult) throws ClassCastException;
	...
	/**
	 * Sorts the {@link org.andengine.entity.IEntity}s based on the {@link Comparator} supplied. Sort is stable.
	 ...
	 */
	public boolean detachChild(final org.andengine.entity.IEntity pEntity);
	/**
	 * <b><i>WARNING:</i> This function should be called from within
	 * {@link RunnableHandler#postRunnable(Runnable)} which is registered
	 * to a {@link Scene} or the {@link Engine} itself, because otherwise
	 ...
	 * Update-Thread or the GL-Thread!</b>
	 */
	public org.andengine.entity.IEntity detachChild(final int pTag);
	/**
	 * <b><i>WARNING:</i> This function should be called from within
	 * {@link RunnableHandler#postRunnable(Runnable)} which is registered
	 * to a {@link Scene} or the {@link Engine} itself, because otherwise
	 ...
	 * Update-Thread or the GL-Thread!</b>
	 */
	public org.andengine.entity.IEntity detachChild(final IEntityMatcher pEntityMatcher);
	/**
	 * <b><i>WARNING:</i> This function should be called from within
	 * {@link RunnableHandler#postRunnable(Runnable)} which is registered
	 * to a {@link Scene} or the {@link Engine} itself, because otherwise
	...
	public boolean collidesWith(final org.andengine.entity.IEntity pOtherEntity);
