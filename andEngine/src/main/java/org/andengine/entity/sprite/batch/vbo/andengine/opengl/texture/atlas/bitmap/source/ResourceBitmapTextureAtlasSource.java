...
public class ResourceBitmapTextureAtlasSource extends BaseTextureAtlasSource implements IBitmapTextureAtlasSource {
	...
	public static org.andengine.opengl.texture.atlas.bitmap.source.ResourceBitmapTextureAtlasSource create(final Resources pResources, final int pDrawableResourceID) {
		return org.andengine.opengl.texture.atlas.bitmap.source.ResourceBitmapTextureAtlasSource.create(pResources, pDrawableResourceID, 0, 0);
	}

	public static org.andengine.opengl.texture.atlas.bitmap.source.ResourceBitmapTextureAtlasSource create(final Resources pResources, final int pDrawableResourceID, final int pTextureX, final int pTextureY) {
...
//		decodeOptions.inScaled = false; // TODO Check how this behaves with drawable-""/nodpi/ldpi/mdpi/hdpi folders
		...
		return new org.andengine.opengl.texture.atlas.bitmap.source.ResourceBitmapTextureAtlasSource(pResources, pDrawableResourceID, pTextureX, pTextureY, decodeOptions.outWidth, decodeOptions.outHeight);
	}
	...
	@Override
	public org.andengine.opengl.texture.atlas.bitmap.source.ResourceBitmapTextureAtlasSource deepCopy() {
		return new org.andengine.opengl.texture.atlas.bitmap.source.ResourceBitmapTextureAtlasSource(this.mResources, this.mDrawableResourceID, this.mTextureX, this.mTextureY, this.mTextureWidth, this.mTextureHeight);
	}
