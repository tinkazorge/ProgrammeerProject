package org.andengine.entity.sprite.batch.vbo.andengine.entity.text;
...
public class Text extends Shape {
	...
	public static final int VERTEX_INDEX_Y = org.andengine.entity.text.Text.VERTEX_INDEX_X + 1;
	public static final int COLOR_INDEX = org.andengine.entity.text.Text.VERTEX_INDEX_Y + 1;
	public static final int TEXTURECOORDINATES_INDEX_U = org.andengine.entity.text.Text.COLOR_INDEX + 1;
	public static final int TEXTURECOORDINATES_INDEX_V = org.andengine.entity.text.Text.TEXTURECOORDINATES_INDEX_U + 1;

	public static final int VERTEX_SIZE = 2 + 1 + 2;
	public static final int VERTICES_PER_LETTER = 6;
	public static final int LETTER_SIZE = org.andengine.entity.text.Text.VERTEX_SIZE * org.andengine.entity.text.Text.VERTICES_PER_LETTER;
	public static final int VERTEX_STRIDE = org.andengine.entity.text.Text.VERTEX_SIZE * DataConstants.BYTES_PER_FLOAT;
	...
	public Text(final float pX, final float pY, final IFont pFont, final CharSequence pText, final int pCharactersMaximum, final TextOptions pTextOptions, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX, pY, pFont, pText, pCharactersMaximum, pTextOptions, new HighPerformanceTextVertexBufferObject(pVertexBufferObjectManager, org.andengine.entity.text.Text.LETTER_SIZE * pCharactersMaximum, pDrawType, true, org.andengine.entity.text.Text.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
	...
	public Text(final float pX, final float pY, final IFont pFont, final CharSequence pText, final int pCharactersMaximum, final TextOptions pTextOptions, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType, final ShaderProgram pShaderProgram) {
		this(pX, pY, pFont, pText, pCharactersMaximum, pTextOptions, new HighPerformanceTextVertexBufferObject(pVertexBufferObjectManager, org.andengine.entity.text.Text.LETTER_SIZE * pCharactersMaximum, pDrawType, true, org.andengine.entity.text.Text.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT), pShaderProgram);
	}
	...
	public Text(final float pX, final float pY, final IFont pFont, final CharSequence pText, final int pCharactersMaximum, final TextOptions pTextOptions, final ITextVertexBufferObject pTextVertexBufferObject, final ShaderProgram pShaderProgram) {
		...
		this.mVertexCount = org.andengine.entity.text.Text.VERTICES_PER_LETTER * this.mCharactersMaximum;
	...
	/**
	 * @param pText
	 * @throws OutOfCharactersException leaves this {@link org.andengine.entity.text.Text} object in an undefined state, until {@link #setText(CharSequence)} is called again and no {@link OutOfCharactersException} is thrown.
	 */
	public void setText(final CharSequence pText) throws OutOfCharactersException {
		...
		if (this.mTextOptions.mAutoWrap == org.andengine.entity.text.AutoWrap.NONE) {
	...
	public org.andengine.entity.text.AutoWrap getAutoWrap() {
	...
	public void setCharactersToDraw(final int pCharactersToDraw) {
		...
		this.mVertexCountToDraw = pCharactersToDraw * org.andengine.entity.text.Text.VERTICES_PER_LETTER;
	}
