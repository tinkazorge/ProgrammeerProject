...
public class PinchZoomDetector extends BaseDetector {
	...
	/**
	 * When {@link #isZooming()} this method will call through to {@link IPinchZoomDetectorListener#onPinchZoomFinished(org.andengine.input.touch.detector.PinchZoomDetector, TouchEvent, float)}.
	 */
	@Override
	public void reset() {
	...
	public boolean onManagedTouchEvent(final TouchEvent pSceneTouchEvent) {
		...
		switch (action) {
			case MotionEvent.ACTION_POINTER_DOWN:
				if (!this.mPinchZooming && org.andengine.input.touch.detector.PinchZoomDetector.hasTwoOrMorePointers(motionEvent)) {
					this.mInitialDistance = org.andengine.input.touch.detector.PinchZoomDetector.calculatePointerDistance(motionEvent);
					this.mCurrentDistance = this.mInitialDistance;
					if (this.mInitialDistance > org.andengine.input.touch.detector.PinchZoomDetector.TRIGGER_PINCHZOOM_MINIMUM_DISTANCE_DEFAULT) {
			...
			case MotionEvent.ACTION_MOVE:
				if (this.mPinchZooming) {
					if (org.andengine.input.touch.detector.PinchZoomDetector.hasTwoOrMorePointers(motionEvent)) {
						this.mCurrentDistance = org.andengine.input.touch.detector.PinchZoomDetector.calculatePointerDistance(motionEvent);
						if (this.mCurrentDistance > org.andengine.input.touch.detector.PinchZoomDetector.TRIGGER_PINCHZOOM_MINIMUM_DISTANCE_DEFAULT) {
	...
	public static interface IPinchZoomDetectorListener {
		...
		public void onPinchZoomStarted(final org.andengine.input.touch.detector.PinchZoomDetector pPinchZoomDetector, final TouchEvent pSceneTouchEvent);
		public void onPinchZoom(final org.andengine.input.touch.detector.PinchZoomDetector pPinchZoomDetector, final TouchEvent pTouchEvent, final float pZoomFactor);
		public void onPinchZoomFinished(final org.andengine.input.touch.detector.PinchZoomDetector pPinchZoomDetector, final TouchEvent pTouchEvent, final float pZoomFactor);
	}
}
