...
public class ColorSwapBitmapTextureAtlasSource extends BaseBitmapTextureAtlasSource {
	...
	public ColorSwapBitmapTextureAtlasSource(final IBitmapTextureAtlasSource pBitmapTextureAtlasSource, final int pColorKeyColorARGBPackedInt, final int pColorSwapColorARGBPackedInt) {
		this(pBitmapTextureAtlasSource, pColorKeyColorARGBPackedInt, org.andengine.opengl.texture.atlas.bitmap.source.ColorSwapBitmapTextureAtlasSource.TOLERANCE_DEFAULT, pColorSwapColorARGBPackedInt);
	}
	...
	@Override
	public org.andengine.opengl.texture.atlas.bitmap.source.ColorSwapBitmapTextureAtlasSource deepCopy() {
		return new org.andengine.opengl.texture.atlas.bitmap.source.ColorSwapBitmapTextureAtlasSource(this.mBitmapTextureAtlasSource, this.mColorKeyColorARGBPackedInt, this.mTolerance, this.mColorSwapColorARGBPackedInt);
	}
	...
	protected Bitmap swapColor(final Bitmap pBitmap) {
		...
		switch (config) {
			case ARGB_8888:
				return org.andengine.opengl.texture.atlas.bitmap.source.ColorSwapBitmapTextureAtlasSource.swapColorARGB_8888(pBitmap, this.mColorKeyColorARGBPackedInt, this.mTolerance, this.mColorSwapColorARGBPackedInt);
			default:
