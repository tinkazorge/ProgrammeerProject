...
public class Font implements IFont {
	...
	private int mCurrentTextureX = org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING;
	private int mCurrentTextureY = org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING;
	...
	protected Bitmap getLetterBitmap(final Letter pLetter) throws FontException {
		...
		final int width = pLetter.mWidth + (2 * org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING);
		final int height = pLetter.mHeight + (2 * org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING);
	...
	protected void drawLetter(final String pCharacterAsString, final float pLeft, final float pTop) {
		this.mCanvas.drawText(pCharacterAsString, pLeft + org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING, pTop + org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING, this.mPaint);
	}
	...
	private Letter createLetter(final char pCharacter) throws FontException {
		...
		if (whitespace) {
			...
			if ((this.mCurrentTextureX + org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING + letterWidth) >= textureWidth) {
				this.mCurrentTextureX = 0;
				this.mCurrentTextureY += this.mCurrentTextureYHeightMax + (2 * org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING);
			...
			this.mCurrentTextureX += org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING;
			...
			letter = new Letter(pCharacter, this.mCurrentTextureX - org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING, this.mCurrentTextureY - org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING, letterWidth, letterHeight, letterLeft, letterTop, advance, u, v, u2, v2);
			this.mCurrentTextureX += letterWidth + org.andengine.opengl.font.Font.LETTER_TEXTURE_PADDING;
		}
