...
public class ScaleAtModifier extends ScaleModifier {
	...
	protected ScaleAtModifier(final org.andengine.entity.modifier.ScaleAtModifier pScaleAtModifier) {
	...
	@Override
	public org.andengine.entity.modifier.ScaleAtModifier deepCopy() {
		return new org.andengine.entity.modifier.ScaleAtModifier(this);
	}
