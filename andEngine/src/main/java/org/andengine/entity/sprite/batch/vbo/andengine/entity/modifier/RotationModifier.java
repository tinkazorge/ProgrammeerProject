...
public class RotationModifier extends SingleValueSpanEntityModifier {
	...
	protected RotationModifier(final org.andengine.entity.modifier.RotationModifier pRotationModifier) {
		super(pRotationModifier);
	}

	@Override
	public org.andengine.entity.modifier.RotationModifier deepCopy() {
		return new org.andengine.entity.modifier.RotationModifier(this);
	}
