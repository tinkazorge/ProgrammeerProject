...
/**
 * Compared to a {@link org.andengine.opengl.vbo.HighPerformanceVertexBufferObject}, the {@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject} uses <b><u>50%</u> less heap memory</b>,
 * at the cost of significantly slower data buffering (<b>up to <u>5x</u> slower!</b>).
 *
 * Usually a {@link org.andengine.opengl.vbo.LowMemoryVertexBufferObject} is preferred to a {@link org.andengine.opengl.vbo.HighPerformanceVertexBufferObject} when the following conditions are met:
 * <ol>
 * 	<li>The applications is close to run out of memory.</li>
 * 	<li>You have very big {@link org.andengine.opengl.vbo.HighPerformanceVertexBufferObject} or an extreme number of small {@link HighPerformanceVertexBufferObject}s, where a 50% heap memory reduction would actually be significant.</li>
