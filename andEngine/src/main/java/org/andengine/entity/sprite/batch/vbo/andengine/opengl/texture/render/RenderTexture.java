package org.andengine.entity.sprite.batch.vbo.andengine.opengl.texture.render;
...
/**
 * The general workflow with a {@link org.andengine.opengl.texture.render.RenderTexture} is: {@link #init(GLState)} -> {@link #begin(GLState)} -> {@link #end(GLState)} -> {@link #destroy(GLState)}.
 *
 * (c) 2011 Zynga Inc.
 *
...
public class RenderTexture extends Texture {
	...
	private static final int VIEWPORT_CONTAINER_Y_INDEX = org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER_X_INDEX + 1;
	private static final int VIEWPORT_CONTAINER_WIDTH_INDEX = org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER_Y_INDEX + 1;
	private static final int VIEWPORT_CONTAINER_HEIGHT_INDEX = org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER_WIDTH_INDEX + 1;

	private static final int CLEARCOLOR_CONTAINER_RED_INDEX = 0;
	private static final int CLEARCOLOR_CONTAINER_GREEN_INDEX = org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER_RED_INDEX + 1;
	private static final int CLEARCOLOR_CONTAINER_BLUE_INDEX = org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER_GREEN_INDEX + 1;
	private static final int CLEARCOLOR_CONTAINER_ALPHA_INDEX = org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER_BLUE_INDEX + 1;
	...
	/**
	 * @param pGLState
	 * @throws RenderTextureInitializationException when this {@link org.andengine.opengl.texture.render.RenderTexture} could not be initialized. The {@link GLException} contains the error code. When this exception is throw, all cleanup will be automatically performed through {@link #destroy(GLState)}.
	 */
	...
	public void begin(final GLState pGLState, final boolean pFlipX, final boolean pFlipY, final float pRed, final float pGreen, final float pBlue, final float pAlpha) {
		...
		/* Save clear color. */
		GLES20.glGetFloatv(GLES20.GL_COLOR_CLEAR_VALUE, org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER, 0);

		GLES20.glClearColor(pRed, pGreen, pBlue, pAlpha);
		GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT);

		/* Restore clear color. */
		GLES20.glClearColor(org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER[org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER_RED_INDEX], org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER[org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER_GREEN_INDEX], org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER[org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER_BLUE_INDEX], org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER[org.andengine.opengl.texture.render.RenderTexture.CLEARCOLOR_CONTAINER_ALPHA_INDEX]);
	}
	...
	protected void savePreviousViewport() {
		GLES20.glGetIntegerv(GLES20.GL_VIEWPORT, org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER, 0);

		this.mPreviousViewPortX = org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER[org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER_X_INDEX];
		this.mPreviousViewPortY = org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER[org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER_Y_INDEX];
		this.mPreviousViewPortWidth = org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER[org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER_WIDTH_INDEX];
		this.mPreviousViewPortHeight = org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER[org.andengine.opengl.texture.render.RenderTexture.VIEWPORT_CONTAINER_HEIGHT_INDEX];
	}
