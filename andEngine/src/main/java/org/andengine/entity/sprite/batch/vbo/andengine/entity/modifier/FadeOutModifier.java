...
public class FadeOutModifier extends AlphaModifier {
	...
	protected FadeOutModifier(final org.andengine.entity.modifier.FadeOutModifier pFadeOutModifier) {
		super(pFadeOutModifier);
	}

	@Override
	public org.andengine.entity.modifier.FadeOutModifier deepCopy() {
		return new org.andengine.entity.modifier.FadeOutModifier(this);
	}
