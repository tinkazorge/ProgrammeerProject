...
public class GLScissorStack {
	...
	private static final int GLSCISSORSTACKOFFSET_UNDERFLOW = -1 * org.andengine.opengl.util.GLScissorStack.GLSCISSOR_SIZE;
	private static final int GLSCISSORSTACKOFFSET_OVERFLOW = org.andengine.opengl.util.GLScissorStack.GLSCISSORSTACK_DEPTH_MAX * org.andengine.opengl.util.GLScissorStack.GLSCISSOR_SIZE;

	// ===========================================================
	// Fields
	// ===========================================================

	private final int[] mScissorStack = new int[org.andengine.opengl.util.GLScissorStack.GLSCISSORSTACK_DEPTH_MAX * org.andengine.opengl.util.GLScissorStack.GLSCISSOR_SIZE];
	...
	public int[] getScissor(final int[] pScissors) {
		if (this.mScissorStackOffset - org.andengine.opengl.util.GLScissorStack.GLSCISSOR_SIZE <= org.andengine.opengl.util.GLScissorStack.GLSCISSORSTACKOFFSET_UNDERFLOW) {
			throw new GLScissorStackUnderflowException();
		}

		System.arraycopy(this.mScissorStack, this.mScissorStackOffset, pScissors, 0, org.andengine.opengl.util.GLScissorStack.GLSCISSOR_SIZE);
		return pScissors;
	}
	...
	public void glPushScissor(final int pX, final int pY, final int pWidth, final int pHeight) {
		if (this.mScissorStackOffset + org.andengine.opengl.util.GLScissorStack.GLSCISSOR_SIZE >= org.andengine.opengl.util.GLScissorStack.GLSCISSORSTACKOFFSET_OVERFLOW) {
		...
		this.mScissorStackOffset += org.andengine.opengl.util.GLScissorStack.GLSCISSOR_SIZE;
	}
