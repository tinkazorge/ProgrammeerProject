package org.andengine.entity.sprite.batch.vbo.andengine;
...
public final class AndEngine {
	...
	public static boolean isDeviceSupported(final Context pContext) {
		try {
			org.andengine.AndEngine.checkDeviceSupported(pContext);
			return true;
	...
	public static void checkDeviceSupported(final Context pContext) throws DeviceNotSupportedException {
		org.andengine.AndEngine.checkCodePathSupport();

		org.andengine.AndEngine.checkOpenGLSupport(pContext);
	}
	...
	private static void checkOpenGLSupport(final Context pContext) throws DeviceNotSupportedException {
		org.andengine.AndEngine.checkGLES20Support(pContext);
		org.andengine.AndEngine.checkEGLConfigChooserSupport();
	}
