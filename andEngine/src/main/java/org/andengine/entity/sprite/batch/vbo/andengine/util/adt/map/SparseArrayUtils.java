...
import org.andengine.util.adt.map.SparseByteArray;
import org.andengine.util.adt.map.SparseCharArray;
import org.andengine.util.adt.map.SparseDoubleArray;
import org.andengine.util.adt.map.SparseFloatArray;
import org.andengine.util.adt.map.SparseLongArray;
...
public final class SparseArrayUtils {
	...
	public static final String toString(final org.andengine.util.adt.map.SparseByteArray pSparseByteArray) {
		final StringBuilder stringBuilder = new StringBuilder();
