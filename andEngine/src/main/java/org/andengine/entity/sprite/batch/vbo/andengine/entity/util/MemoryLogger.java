package org.andengine.entity.sprite.batch.vbo.andengine.entity.util;
...
public class MemoryLogger implements IUpdateHandler {
	...
	public MemoryLogger(final DebugLevel pDebugLevel) {
		this(org.andengine.entity.util.MemoryLogger.AVERAGE_DURATION_DEFAULT, pDebugLevel);
	}
		...
		if (BuildConfig.DEBUG) {
			...
			try {
				...
				if (this.mLogSystemMemory) {
					...
					stringBuilder.append("| System memory size           | " + org.andengine.entity.util.MemoryLogger.formatRight(systemMemorySize, ' ', 10) + " kB | (" + org.andengine.entity.util.MemoryLogger.formatRight(systemMemorySizeDiff, ' ', 10, true) + " kB) |\n");
					stringBuilder.append("| System memory free size      | " + org.andengine.entity.util.MemoryLogger.formatRight(systemMemoryFreeSize, ' ', 10) + " kB | (" + org.andengine.entity.util.MemoryLogger.formatRight(systemMemoryFreeSizeDiff, ' ', 10, true) + " kB) |\n");
					stringBuilder.append("+------------------------------+---------------+-----------------+\n");
				}
				...
				if (this.mLogDalvikHeap) {
					...
					stringBuilder.append("| Dalvik memory size           | " + org.andengine.entity.util.MemoryLogger.formatRight(dalvikHeapSize, ' ', 10) + " kB | (" + org.andengine.entity.util.MemoryLogger.formatRight(dalvikHeapSizeDiff, ' ', 10, true) + " kB) |\n");
					stringBuilder.append("| Dalvik memory free size      | " + org.andengine.entity.util.MemoryLogger.formatRight(dalvikHeapFreeSize, ' ', 10) + " kB | (" + org.andengine.entity.util.MemoryLogger.formatRight(dalvikHeapFreeSizeDiff, ' ', 10, true) + " kB) |\n");
					stringBuilder.append("| Dalvik memory allocated size | " + org.andengine.entity.util.MemoryLogger.formatRight(dalvikHeapAllocatedSize, ' ', 10) + " kB | (" + org.andengine.entity.util.MemoryLogger.formatRight(dalvikHeapAllocatedSizeDiff, ' ', 10, true) + " kB) |\n");
					stringBuilder.append("+------------------------------+---------------+-----------------+\n");
				...
				if (this.mLogDalvikMemoryInfo) {
					...
					stringBuilder.append("| Dalvik proportional set size | " + org.andengine.entity.util.MemoryLogger.formatRight(dalvikProportionalSetSize, ' ', 10) + "    | (" + org.andengine.entity.util.MemoryLogger.formatRight(dalvikProportionalSetSizeDiff, ' ', 10, true) + "   ) |\n");
					stringBuilder.append("| Dalvik private dirty pages   | " + org.andengine.entity.util.MemoryLogger.formatRight(dalvikPrivateDirtyPages, ' ', 10) + "    | (" + org.andengine.entity.util.MemoryLogger.formatRight(dalvikPrivateDirtyPagesDiff, ' ', 10, true) + "   ) |\n");
					stringBuilder.append("| Dalvik shared dirty pages    | " + org.andengine.entity.util.MemoryLogger.formatRight(dalvikSharedDirtyPages, ' ', 10) + "    | (" + org.andengine.entity.util.MemoryLogger.formatRight(dalvikSharedDirtyPagesDiff, ' ', 10, true) + "   ) |\n");
					stringBuilder.append("+------------------------------+---------------+-----------------+\n");
				...
				if (this.mLogNativeHeap) {
					...
					stringBuilder.append("| Native memory size           | " + org.andengine.entity.util.MemoryLogger.formatRight(nativeHeapSize, ' ', 10) + " kB | (" + org.andengine.entity.util.MemoryLogger.formatRight(nativeHeapSizeDiff, ' ', 10, true) + " kB) |\n");
					stringBuilder.append("| Native memory free size      | " + org.andengine.entity.util.MemoryLogger.formatRight(nativeHeapFreeSize, ' ', 10) + " kB | (" + org.andengine.entity.util.MemoryLogger.formatRight(nativeHeapFreeSizeDiff, ' ', 10, true) + " kB) |\n");
					stringBuilder.append("| Native memory allocated size | " + org.andengine.entity.util.MemoryLogger.formatRight(nativeHeapAllocatedSize, ' ', 10) + " kB | (" + org.andengine.entity.util.MemoryLogger.formatRight(nativeHeapAllocatedSizeDiff, ' ', 10, true) + " kB) |\n");
					stringBuilder.append("+------------------------------+---------------+-----------------+\n");
				...
				if (this.mLogNativeMemoryInfo) {
					...
					stringBuilder.append("| Native proportional set size | " + org.andengine.entity.util.MemoryLogger.formatRight(nativeProportionalSetSize, ' ', 10) + "    | (" + org.andengine.entity.util.MemoryLogger.formatRight(nativeProportionalSetSizeDiff, ' ', 10, true) + "   ) |\n");
					stringBuilder.append("| Native private dirty pages   | " + org.andengine.entity.util.MemoryLogger.formatRight(nativePrivateDirtyPages, ' ', 10) + "    | (" + org.andengine.entity.util.MemoryLogger.formatRight(nativePrivateDirtyPagesDiff, ' ', 10, true) + "   ) |\n");
					stringBuilder.append("| Native shared dirty pages    | " + org.andengine.entity.util.MemoryLogger.formatRight(nativeSharedDirtyPages, ' ', 10) + "    | (" + org.andengine.entity.util.MemoryLogger.formatRight(nativeSharedDirtyPagesDiff, ' ', 10, true) + "   ) |\n");
					stringBuilder.append("+------------------------------+---------------+-----------------+\n");
	...
	public static final CharSequence formatRight(final long pLong, final char pPadChar, final int pLength) {
		return org.andengine.entity.util.MemoryLogger.formatRight(pLong, pPadChar, pLength, false);
	}
