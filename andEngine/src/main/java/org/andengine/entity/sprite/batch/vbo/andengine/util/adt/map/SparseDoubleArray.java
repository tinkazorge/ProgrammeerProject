...
public class SparseDoubleArray implements Cloneable {
    ...
    @Override
    public org.andengine.util.adt.map.SparseDoubleArray clone() {
        org.andengine.util.adt.map.SparseDoubleArray clone = null;
        try {
            clone = (org.andengine.util.adt.map.SparseDoubleArray) super.clone();
