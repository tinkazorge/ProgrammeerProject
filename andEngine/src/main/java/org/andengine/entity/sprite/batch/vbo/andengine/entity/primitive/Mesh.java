...
public class Mesh extends Shape {
	...
	public static final int VERTEX_INDEX_Y = org.andengine.entity.primitive.Mesh.VERTEX_INDEX_X + 1;
	public static final int COLOR_INDEX = org.andengine.entity.primitive.Mesh.VERTEX_INDEX_Y + 1;
	...
	/**
	 * Uses a default {@link HighPerformanceMeshVertexBufferObject} in {@link DrawType#STATIC} with the {@link VertexBufferObjectAttribute}s: {@link org.andengine.entity.primitive.Mesh#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	...
	/**
	 * Uses a default {@link HighPerformanceMeshVertexBufferObject} with the {@link VertexBufferObjectAttribute}s: {@link org.andengine.entity.primitive.Mesh#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	...
	public Mesh(final float pX, final float pY, final float pWidth, final float pHeight, final float[] pBufferData, final int pVertexCount, final DrawMode pDrawMode, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX, pY, pWidth, pHeight, pVertexCount, pDrawMode, new HighPerformanceMeshVertexBufferObject(pVertexBufferObjectManager, pBufferData, pVertexCount, pDrawType, true, org.andengine.entity.primitive.Mesh.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
	...
	public boolean collidesWith(final IEntity pOtherEntity) {
		if (pOtherEntity instanceof org.andengine.entity.primitive.Mesh) {
			// TODO
