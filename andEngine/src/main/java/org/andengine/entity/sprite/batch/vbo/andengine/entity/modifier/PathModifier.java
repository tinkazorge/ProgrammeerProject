...
public class PathModifier extends EntityModifier {
		...
		this.mSequenceModifier = new SequenceModifier<IEntity>(
				new ISubSequenceModifierListener<IEntity>() {
					...
					public void onSubSequenceStarted(final IModifier<IEntity> pModifier, final IEntity pEntity, final int pIndex) {
						if (org.andengine.entity.modifier.PathModifier.this.mPathModifierListener != null) {
							org.andengine.entity.modifier.PathModifier.this.mPathModifierListener.onPathWaypointStarted(org.andengine.entity.modifier.PathModifier.this, pEntity, pIndex);
						}
					}
					...
					public void onSubSequenceFinished(final IModifier<IEntity> pEntityModifier, final IEntity pEntity, final int pIndex) {
						if (org.andengine.entity.modifier.PathModifier.this.mPathModifierListener != null) {
							org.andengine.entity.modifier.PathModifier.this.mPathModifierListener.onPathWaypointFinished(org.andengine.entity.modifier.PathModifier.this, pEntity, pIndex);
						}
					}
				},
				new IEntityModifierListener() {
					...
					public void onModifierStarted(final IModifier<IEntity> pModifier, final IEntity pEntity) {
						org.andengine.entity.modifier.PathModifier.this.onModifierStarted(pEntity);
						if (org.andengine.entity.modifier.PathModifier.this.mPathModifierListener != null) {
							org.andengine.entity.modifier.PathModifier.this.mPathModifierListener.onPathStarted(org.andengine.entity.modifier.PathModifier.this, pEntity);
						}
					}

					@Override
					public void onModifierFinished(final IModifier<IEntity> pEntityModifier, final IEntity pEntity) {
						org.andengine.entity.modifier.PathModifier.this.onModifierFinished(pEntity);
						if (org.andengine.entity.modifier.PathModifier.this.mPathModifierListener != null) {
							org.andengine.entity.modifier.PathModifier.this.mPathModifierListener.onPathFinished(org.andengine.entity.modifier.PathModifier.this, pEntity);
						}
					}
				},
				moveModifiers
	...
	protected PathModifier(final org.andengine.entity.modifier.PathModifier pPathModifier) throws DeepCopyNotSupportedException {
		this.mPath = pPathModifier.mPath.deepCopy();
		this.mSequenceModifier = pPathModifier.mSequenceModifier.deepCopy();
	}

	@Override
	public org.andengine.entity.modifier.PathModifier deepCopy() throws DeepCopyNotSupportedException {
		return new org.andengine.entity.modifier.PathModifier(this);
	}
	...
	public static interface IPathModifierListener {
		...
		public void onPathStarted(final org.andengine.entity.modifier.PathModifier pPathModifier, final IEntity pEntity);
		public void onPathWaypointStarted(final org.andengine.entity.modifier.PathModifier pPathModifier, final IEntity pEntity, final int pWaypointIndex);
		public void onPathWaypointFinished(final org.andengine.entity.modifier.PathModifier pPathModifier, final IEntity pEntity, final int pWaypointIndex);
		public void onPathFinished(final org.andengine.entity.modifier.PathModifier pPathModifier, final IEntity pEntity);
	}
