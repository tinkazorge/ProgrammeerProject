...
public class EaseElasticIn implements IEaseFunction {
	...
	private static org.andengine.util.modifier.ease.EaseElasticIn INSTANCE;
	...
	public static org.andengine.util.modifier.ease.EaseElasticIn getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new org.andengine.util.modifier.ease.EaseElasticIn();
		}
		return INSTANCE;
	}
	...
	public float getPercentage(final float pSecondsElapsed, final float pDuration) {
		return org.andengine.util.modifier.ease.EaseElasticIn.getValue(pSecondsElapsed, pDuration, pSecondsElapsed / pDuration);
	}
