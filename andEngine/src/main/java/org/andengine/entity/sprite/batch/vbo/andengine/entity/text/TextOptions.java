...
public class TextOptions {
	...
	/* package */ org.andengine.entity.text.AutoWrap mAutoWrap;
	...
	public TextOptions() {
		this(org.andengine.entity.text.AutoWrap.NONE, 0, HorizontalAlign.LEFT, Text.LEADING_DEFAULT);
	}

	public TextOptions(final HorizontalAlign pHorizontalAlign) {
		this(org.andengine.entity.text.AutoWrap.NONE, 0, pHorizontalAlign, Text.LEADING_DEFAULT);
	}

	public TextOptions(final org.andengine.entity.text.AutoWrap pAutoWrap, final float pAutoWrapWidth) {
		this(pAutoWrap, pAutoWrapWidth, HorizontalAlign.LEFT, Text.LEADING_DEFAULT);
	}

	public TextOptions(final org.andengine.entity.text.AutoWrap pAutoWrap, final float pAutoWrapWidth, final HorizontalAlign pHorizontalAlign) {
		this(pAutoWrap, pAutoWrapWidth, pHorizontalAlign, Text.LEADING_DEFAULT);
	}

	public TextOptions(final org.andengine.entity.text.AutoWrap pAutoWrap, final float pAutoWrapWidth, final HorizontalAlign pHorizontalAlign, final float pLeading) {
