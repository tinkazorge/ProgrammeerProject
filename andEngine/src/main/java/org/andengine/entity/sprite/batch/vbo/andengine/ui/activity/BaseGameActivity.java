...
public abstract class BaseGameActivity extends BaseActivity implements IGameInterface, IRendererListener {
	...
	protected synchronized void onCreateGame() {
		...
		final OnPopulateSceneCallback onPopulateSceneCallback = new OnPopulateSceneCallback() {
			...
			public void onPopulateSceneFinished() {
				try {
					if (BuildConfig.DEBUG) {
						Debug.d(org.andengine.ui.activity.BaseGameActivity.this.getClass().getSimpleName() + ".onGameCreated" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					org.andengine.ui.activity.BaseGameActivity.this.onGameCreated();
				} catch(final Throwable pThrowable) {
					Debug.e(org.andengine.ui.activity.BaseGameActivity.this.getClass().getSimpleName() + ".onGameCreated failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}

				org.andengine.ui.activity.BaseGameActivity.this.callGameResumedOnUIThread();
			}
		};
		...
		final OnCreateSceneCallback onCreateSceneCallback = new OnCreateSceneCallback() {
			...
			public void onCreateSceneFinished(final Scene pScene) {
				org.andengine.ui.activity.BaseGameActivity.this.mEngine.setScene(pScene);

				try {
					if (BuildConfig.DEBUG) {
						Debug.d(org.andengine.ui.activity.BaseGameActivity.this.getClass().getSimpleName() + ".onPopulateScene" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					org.andengine.ui.activity.BaseGameActivity.this.onPopulateScene(pScene, onPopulateSceneCallback);
				} catch(final Throwable pThrowable) {
					Debug.e(org.andengine.ui.activity.BaseGameActivity.this.getClass().getSimpleName() + ".onPopulateScene failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
			}
		};
		...
		final OnCreateResourcesCallback onCreateResourcesCallback = new OnCreateResourcesCallback() {
			...
			public void onCreateResourcesFinished() {
				try {
					if (BuildConfig.DEBUG) {
						Debug.d(org.andengine.ui.activity.BaseGameActivity.this.getClass().getSimpleName() + ".onCreateScene" + " @(Thread: '" + Thread.currentThread().getName() + "')");
					}

					org.andengine.ui.activity.BaseGameActivity.this.onCreateScene(onCreateSceneCallback);
				} catch(final Throwable pThrowable) {
					Debug.e(org.andengine.ui.activity.BaseGameActivity.this.getClass().getSimpleName() + ".onCreateScene failed." + " @(Thread: '" + Thread.currentThread().getName() + "')", pThrowable);
				}
			}
		};
	...
	private void callGameResumedOnUIThread() {
		org.andengine.ui.activity.BaseGameActivity.this.runOnUiThread(new Runnable() {
			@Override
			public void run() {
				if (!org.andengine.ui.activity.BaseGameActivity.this.isFinishing()) {
					org.andengine.ui.activity.BaseGameActivity.this.onResumeGame();
				}
			}
		});
	}
	...
	protected void onSetContentView() {
		...
		this.setContentView(this.mRenderSurfaceView, org.andengine.ui.activity.BaseGameActivity.createSurfaceViewLayoutParams());
	}
