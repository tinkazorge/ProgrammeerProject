...
public class ScaleModifier extends DoubleValueSpanEntityModifier {
	...
	protected ScaleModifier(final org.andengine.entity.modifier.ScaleModifier pScaleModifier) {
		super(pScaleModifier);
	}

	@Override
	public org.andengine.entity.modifier.ScaleModifier deepCopy() {
		return new org.andengine.entity.modifier.ScaleModifier(this);
	}
