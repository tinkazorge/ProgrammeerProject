...
public class Gradient extends Shape {
	...
	public static final int VERTEX_INDEX_Y = org.andengine.entity.primitive.Gradient.VERTEX_INDEX_X + 1;
	public static final int COLOR_INDEX = org.andengine.entity.primitive.Gradient.VERTEX_INDEX_Y + 1;

	public static final int VERTEX_SIZE = 2 + 1;
	public static final int VERTICES_PER_RECTANGLE = 4;
	public static final int RECTANGLE_SIZE = org.andengine.entity.primitive.Gradient.VERTEX_SIZE * org.andengine.entity.primitive.Gradient.VERTICES_PER_RECTANGLE;
	...
	/**
	 * Uses a default {@link HighPerformanceGradientVertexBufferObject} in {@link DrawType#STATIC} with the {@link VertexBufferObjectAttribute}s: {@link org.andengine.entity.primitive.Gradient#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	...
	/**
	 * Uses a default {@link HighPerformanceGradientVertexBufferObject} with the {@link VertexBufferObjectAttribute}s: {@link org.andengine.entity.primitive.Gradient#VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT}.
	 */
	public Gradient(final float pX, final float pY, final float pWidth, final float pHeight, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX, pY, pWidth, pHeight, new HighPerformanceGradientVertexBufferObject(pVertexBufferObjectManager, org.andengine.entity.primitive.Gradient.RECTANGLE_SIZE, pDrawType, true, org.andengine.entity.primitive.Gradient.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
	...
	protected void draw(final GLState pGLState, final Camera pCamera) {
		if (this.mGradientDitherEnabled) {
			...
			this.mGradientVertexBufferObject.draw(GLES20.GL_TRIANGLE_STRIP, org.andengine.entity.primitive.Gradient.VERTICES_PER_RECTANGLE);
