...
public class AssetBitmapTextureAtlasSource extends BaseTextureAtlasSource implements IBitmapTextureAtlasSource {
	...
	public static org.andengine.opengl.texture.atlas.bitmap.source.AssetBitmapTextureAtlasSource create(final AssetManager pAssetManager, final String pAssetPath) {
		return org.andengine.opengl.texture.atlas.bitmap.source.AssetBitmapTextureAtlasSource.create(pAssetManager, pAssetPath, 0, 0);
	}

	public static org.andengine.opengl.texture.atlas.bitmap.source.AssetBitmapTextureAtlasSource create(final AssetManager pAssetManager, final String pAssetPath, final int pTextureX, final int pTextureY) {
		...
		return new org.andengine.opengl.texture.atlas.bitmap.source.AssetBitmapTextureAtlasSource(pAssetManager, pAssetPath, pTextureX, pTextureY, decodeOptions.outWidth, decodeOptions.outHeight);
	}
	...
	@Override
	public org.andengine.opengl.texture.atlas.bitmap.source.AssetBitmapTextureAtlasSource deepCopy() {
		return new org.andengine.opengl.texture.atlas.bitmap.source.AssetBitmapTextureAtlasSource(this.mAssetManager, this.mAssetPath, this.mTextureX, this.mTextureY, this.mTextureWidth, this.mTextureHeight);
	}
