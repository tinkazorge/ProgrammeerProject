...
public class AnimatedSprite extends TiledSprite {
		...
		if (this.mAnimationRunning) {
			...
			if (!this.mAnimationStartedFired && (this.mAnimationProgress == 0)) {
				...
				if (this.mAnimationListener != null) {
					...
					this.mAnimationListener.onAnimationFrameChanged(this, org.andengine.entity.sprite.AnimatedSprite.FRAMEINDEX_INVALID, 0);
				}
			}
	...
	public static interface IAnimationListener {
		 ...
		 */
		public void onAnimationStarted(final org.andengine.entity.sprite.AnimatedSprite pAnimatedSprite, final int pInitialLoopCount);
		/**
		 * @param pAnimatedSprite
		 * @param pOldFrameIndex equals {@link org.andengine.entity.sprite.AnimatedSprite#FRAMEINDEX_INVALID}, the first time {@link IAnimationListener#onAnimationFrameChanged(org.andengine.entity.sprite.AnimatedSprite, int, int)} is called.
		 * @param pNewFrameIndex the new frame index of the currently active animation.
		 */
		public void onAnimationFrameChanged(final org.andengine.entity.sprite.AnimatedSprite pAnimatedSprite, final int pOldFrameIndex, final int pNewFrameIndex);
		/**
		 * @param pAnimatedSprite
		 ...
		 * @param pInitialLoopCount is {@link org.andengine.entity.sprite.AnimatedSprite#LOOP_CONTINUOUS} when {@link org.andengine.entity.sprite.AnimatedSprite} loops infinitely.
		 */
		public void onAnimationLoopFinished(final org.andengine.entity.sprite.AnimatedSprite pAnimatedSprite, final int pRemainingLoopCount, final int pInitialLoopCount);
		public void onAnimationFinished(final org.andengine.entity.sprite.AnimatedSprite pAnimatedSprite);
	}
}
