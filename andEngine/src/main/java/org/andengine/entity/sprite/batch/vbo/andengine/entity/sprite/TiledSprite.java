package org.andengine.entity.sprite.batch.vbo.andengine.entity.sprite;
 ...
 */
public class TiledSprite extends org.andengine.entity.sprite.Sprite {
	// ===========================================================
	// Constants
	// ===========================================================

	public static final int VERTEX_SIZE = org.andengine.entity.sprite.Sprite.VERTEX_SIZE;
	public static final int VERTICES_PER_TILEDSPRITE = 6;
	public static final int TILEDSPRITE_SIZE = org.andengine.entity.sprite.TiledSprite.VERTEX_SIZE * org.andengine.entity.sprite.TiledSprite.VERTICES_PER_TILEDSPRITE;
	...
	public TiledSprite(final float pX, final float pY, final float pWidth, final float pHeight, final ITiledTextureRegion pTiledTextureRegion, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX, pY, pWidth, pHeight, pTiledTextureRegion, new HighPerformanceTiledSpriteVertexBufferObject(pVertexBufferObjectManager, org.andengine.entity.sprite.TiledSprite.TILEDSPRITE_SIZE * pTiledTextureRegion.getTileCount(), pDrawType, true, org.andengine.entity.sprite.Sprite.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
	...
	public TiledSprite(final float pX, final float pY, final float pWidth, final float pHeight, final ITiledTextureRegion pTiledTextureRegion, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType, final ShaderProgram pShaderProgram) {
		this(pX, pY, pWidth, pHeight, pTiledTextureRegion, new HighPerformanceTiledSpriteVertexBufferObject(pVertexBufferObjectManager, org.andengine.entity.sprite.TiledSprite.TILEDSPRITE_SIZE * pTiledTextureRegion.getTileCount(), pDrawType, true, Sprite.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT), pShaderProgram);
	}
	...
	protected void draw(final GLState pGLState, final Camera pCamera) {
		this.mTiledSpriteVertexBufferObject.draw(GLES20.GL_TRIANGLES, this.mCurrentTileIndex * org.andengine.entity.sprite.TiledSprite.VERTICES_PER_TILEDSPRITE, org.andengine.entity.sprite.TiledSprite.VERTICES_PER_TILEDSPRITE);
	}
