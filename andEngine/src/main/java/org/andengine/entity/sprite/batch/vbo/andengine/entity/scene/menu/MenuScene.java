package org.andengine.entity.sprite.batch.vbo.andengine.entity.scene.menu;
...
public class MenuScene extends CameraScene implements IOnAreaTouchListener, IOnSceneTouchListener {
	...
	@Override
	public org.andengine.entity.scene.menu.MenuScene getChildScene() {
		return (org.andengine.entity.scene.menu.MenuScene)super.getChildScene();
	}
	...
	public void setChildScene(final Scene pChildScene, final boolean pModalDraw, final boolean pModalUpdate, final boolean pModalTouch) throws IllegalArgumentException {
		if (pChildScene instanceof org.andengine.entity.scene.menu.MenuScene) {
			super.setChildScene(pChildScene, pModalDraw, pModalUpdate, pModalTouch);
		} else {
			throw new IllegalArgumentException("A " + org.andengine.entity.scene.menu.MenuScene.class.getSimpleName() + " accepts only " + org.andengine.entity.scene.menu.MenuScene.class.getSimpleName() + " as a ChildScene.");
		}
	}
	...
	public void back(final boolean pResetAnimations, final boolean pResetParentMenuSceneAnimations) {
		...
		if (pResetParentMenuSceneAnimations) {
			if ((this.mParentScene != null) && (this.mParentScene instanceof org.andengine.entity.scene.menu.MenuScene)) {
				((org.andengine.entity.scene.menu.MenuScene)this.mParentScene).resetAnimations();
			}
		}
	}
	...
	public static interface IOnMenuItemClickListener {
		...
		public boolean onMenuItemClicked(final org.andengine.entity.scene.menu.MenuScene pMenuScene, final IMenuItem pMenuItem, final float pMenuItemLocalX, final float pMenuItemLocalY);
	}
}
