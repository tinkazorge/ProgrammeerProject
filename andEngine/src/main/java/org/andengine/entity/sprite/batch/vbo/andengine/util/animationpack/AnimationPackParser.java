...
public class AnimationPackParser extends DefaultHandler {
	...
	private org.andengine.util.animationpack.AnimationPack mAnimationPack;
	...
	public org.andengine.util.animationpack.AnimationPack getAnimationPack() {
	...
	public void startElement(final String pUri, final String pLocalName, final String pQualifiedName, final Attributes pAttributes) throws SAXException {
		if (pLocalName.equals(org.andengine.util.animationpack.AnimationPackParser.TAG_ANIMATIONPACK)) {
			final int version = SAXUtils.getIntAttributeOrThrow(pAttributes, org.andengine.util.animationpack.AnimationPackParser.TAG_ANIMATIONPACK_ATTRIBUTE_VERSION);
			if (version != 1) {
		...
		} else if (pLocalName.equals(org.andengine.util.animationpack.AnimationPackParser.TAG_TEXTUREPACKS)) {
			/* Nothing. */
		} else if (pLocalName.equals(org.andengine.util.animationpack.AnimationPackParser.TAG_TEXTUREPACK)) {
			final String texturePackName = SAXUtils.getAttributeOrThrow(pAttributes, org.andengine.util.animationpack.AnimationPackParser.TAG_TEXTUREPACK_ATTRIBUTE_FILENAME);
		...
		} else if (pLocalName.equals(org.andengine.util.animationpack.AnimationPackParser.TAG_ANIMATIONS)) {
			/* Nothing. */
		} else if (pLocalName.equals(org.andengine.util.animationpack.AnimationPackParser.TAG_ANIMATION)) {
			this.mCurrentAnimationName = SAXUtils.getAttributeOrThrow(pAttributes, org.andengine.util.animationpack.AnimationPackParser.TAG_ANIMATION_ATTRIBUTE_NAME);
			this.mCurrentAnimationLoopCount = SAXUtils.getIntAttribute(pAttributes, org.andengine.util.animationpack.AnimationPackParser.TAG_ANIMATION_ATTRIBUTE_LOOPCOUNT, IAnimationData.LOOP_CONTINUOUS);
		} else if (pLocalName.equals(org.andengine.util.animationpack.AnimationPackParser.TAG_ANIMATIONFRAME)) {
			final int duration = SAXUtils.getIntAttributeOrThrow(pAttributes, org.andengine.util.animationpack.AnimationPackParser.TAG_ANIMATIONFRAME_ATTRIBUTE_DURATION);
			this.mCurrentAnimationFrameDurations.add(duration);

			final String textureRegionName = SAXUtils.getAttributeOrThrow(pAttributes, org.andengine.util.animationpack.AnimationPackParser.TAG_ANIMATIONFRAME_ATTRIBUTE_TEXTUREREGION);
