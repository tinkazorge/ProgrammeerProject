...
/**
 * Note: {@link org.andengine.entity.sprite.ButtonSprite} needs to be registered as a {@link ITouchArea} to the {@link Scene} via {@link Scene#registerTouchArea(ITouchArea)}, otherwise it won't be clickable.
 * To make {@link org.andengine.entity.sprite.ButtonSprite} function properly, you should consider setting {@link Scene#setTouchAreaBindingOnActionDownEnabled(boolean)} to <code>true</code>.
 *
 * (c) 2012 Zynga Inc.
 *
...
public class ButtonSprite extends TiledSprite {
	...
	public interface OnClickListener {
		...
		public void onClick(final org.andengine.entity.sprite.ButtonSprite pButtonSprite, final float pTouchAreaLocalX, final float pTouchAreaLocalY);
	}
