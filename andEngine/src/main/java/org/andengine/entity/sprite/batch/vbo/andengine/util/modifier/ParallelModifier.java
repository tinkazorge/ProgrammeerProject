...
public class ParallelModifier<T> extends BaseModifier<T> implements IModifierListener<T> {
	...
	protected ParallelModifier(final org.andengine.util.modifier.ParallelModifier<T> pParallelModifier) throws DeepCopyNotSupportedException {
	...
	@Override
	public org.andengine.util.modifier.ParallelModifier<T> deepCopy() throws DeepCopyNotSupportedException {
		return new org.andengine.util.modifier.ParallelModifier<T>(this);
	}
