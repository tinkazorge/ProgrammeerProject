...
public final class WifiUtils {
	...
	public static boolean isWifiEnabled(final Context pContext) {
		return org.andengine.util.WifiUtils.getWifiManager(pContext).isWifiEnabled();
	}

	private static void setWifiEnabled(final Context pContext, final boolean pEnabled) {
		org.andengine.util.WifiUtils.getWifiManager(pContext).setWifiEnabled(pEnabled);
	}

	public static String getWifiSSID(final Context pContext) {
		return org.andengine.util.WifiUtils.getWifiManager(pContext).getConnectionInfo().getSSID();
	}

	public static String getWifiSSID(final Context pContext, final boolean pStripQuotes) {
		final String wifiSSID = org.andengine.util.WifiUtils.getWifiSSID(pContext);

		if (pStripQuotes) {
			return org.andengine.util.WifiUtils.stripQuotes(wifiSSID);
		} else {
			return wifiSSID;
		}
	}
	...
	public static byte[] getWifiIPv4AddressRaw(final Context pContext) {
		return org.andengine.util.IPUtils.ipv4AddressToIPAddress(org.andengine.util.WifiUtils.getWifiManager(pContext).getConnectionInfo().getIpAddress());
	}

	public static String getWifiIPv4Address(final Context pContext) throws WifiUtilsException {
		try {
			return org.andengine.util.IPUtils.ipAddressToString(org.andengine.util.WifiUtils.getWifiIPv4AddressRaw(pContext));
	...
	public static boolean isWifiIPAddressValid(final Context pContext) {
		return org.andengine.util.WifiUtils.getWifiManager(pContext).getConnectionInfo().getIpAddress() != 0;
	}
	...
	public static boolean isWifiHotspotSupported(final Context pContext) {
		if (SystemUtils.isAndroidVersionOrLower(Build.VERSION_CODES.ECLAIR_MR1)) {
			...
			final WifiManager wifiManager = org.andengine.util.WifiUtils.getWifiManager(pContext);
			try {
	...
	public static boolean isWifiHotspotEnabled(final Context pContext, final boolean pDefault) {
		try {
			return org.andengine.util.WifiUtils.isWifiHotspotEnabled(pContext);
	...
	public static boolean setWifiHostpotEnabled(final Context pContext, final boolean pEnabled) throws WifiUtilsException {
		return org.andengine.util.WifiUtils.setWifiHostpotEnabled(pContext, null, pEnabled);
	}
	...
	public static boolean setWifiHostpotEnabled(final Context pContext, final WifiConfiguration pWifiConfiguration, final boolean pEnabled) throws WifiUtilsException {
		...
		try {
			if (pEnabled) {
				org.andengine.util.WifiUtils.setWifiEnabled(pContext, false);
			}
	...
	public static String getWifiHotspotSSID(final Context pContext) throws WifiUtilsException {
		return org.andengine.util.WifiUtils.getWifiHotspotConfiguration(pContext).SSID;
	}

	public static String getWifiHotspotSSID(final Context pContext, final boolean pStripQuotes) throws WifiUtilsException {
		final String wifiHotspotSSID = org.andengine.util.WifiUtils.getWifiHotspotSSID(pContext);

		if (pStripQuotes) {
			return org.andengine.util.WifiUtils.stripQuotes(wifiHotspotSSID);
		} else {
	...
	public static boolean isWifiHotspotRunning(final Context pContext) throws WifiUtilsException {
		return org.andengine.util.WifiUtils.getWifiHotspotState(pContext) == WifiHotspotState.ENABLED;
	}
		...
		try {
			...
			while (networkInterfaceEnumeration.hasMoreElements()) {
				...
				if (SystemUtils.isAndroidVersionOrLower(Build.VERSION_CODES.FROYO) || !networkInterface.isLoopback()) {
					...
					if (ArrayUtils.contains(org.andengine.util.WifiUtils.HOTSPOT_NETWORKINTERFACE_NAMES, networkInterfaceName)) {
						final Enumeration<InetAddress> inetAddressEnumeration = networkInterface.getInetAddresses();
						while (inetAddressEnumeration.hasMoreElements()) {
							final InetAddress inetAddress = inetAddressEnumeration.nextElement();
							if (!inetAddress.isLoopbackAddress()) {
								final byte[] ipAddress = inetAddress.getAddress();
								if (ipAddress.length == org.andengine.util.IPUtils.IPV4_LENGTH) {
									return ipAddress;
								} else {
			...
			if (ipv6Address != null) {
				...
				throw new WifiUtilsException("No IP bound to '" + Arrays.toString(org.andengine.util.WifiUtils.HOTSPOT_NETWORKINTERFACE_NAMES) + "'!");
			}
	...
	public static String getWifiHotspotIPAddress() throws WifiUtilsException {
		try {
			return org.andengine.util.IPUtils.ipAddressToString(org.andengine.util.WifiUtils.getWifiHotspotIPAddressRaw());
		} catch (final UnknownHostException e) {
			throw new WifiUtilsException("Unexpected error!", e);
		}
	}
	...
	public static boolean isWifiHotspotIPAddressValid() throws WifiUtilsException { // TODO!
		return !org.andengine.util.WifiUtils.IP_DEFAULT.equals(org.andengine.util.WifiUtils.getWifiHotspotIPAddress());
	}
	...
	public static String getEmulatorIPAddress() throws WifiUtilsException {
		try {
			return org.andengine.util.IPUtils.ipAddressToString(org.andengine.util.WifiUtils.getEmulatorIPAddressRaw());
		} catch (final UnknownHostException e) {
			throw new WifiUtilsException("Unexpected error!", e);
		}
	}
	...
	public static boolean getEmulatorIPAddressValid() throws WifiUtilsException { // TODO!
		return !org.andengine.util.WifiUtils.IP_DEFAULT.equals(org.andengine.util.WifiUtils.getEmulatorIPAddress());
	}
	...
	public static boolean isMulticastEnabled(final Context pContext, final boolean pDefault) {
		try {
			return org.andengine.util.WifiUtils.isMulticastEnabled(pContext);
		} catch (final WifiUtilsException e) {
			return pDefault;
		}
	}
	...
	public static MulticastLock aquireMulticastLock(final Context pContext) {
		return org.andengine.util.WifiUtils.aquireMulticastLock(pContext, org.andengine.util.WifiUtils.MULTICASTLOCK_NAME_DEFAULT);
	}
	...
	public static byte[] getBroadcastIPAddressRaw(final Context pContext) throws WifiUtilsException {
		...
		final byte[] broadcastIP = new byte[org.andengine.util.IPUtils.IPV4_LENGTH];
