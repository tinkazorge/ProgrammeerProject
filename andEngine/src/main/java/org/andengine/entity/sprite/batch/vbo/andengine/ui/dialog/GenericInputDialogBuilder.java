package org.andengine.entity.sprite.batch.vbo.andengine.ui.dialog;
	...
	public Dialog create() {
		...
		.setPositiveButton(android.R.string.ok, new OnClickListener() {
			...
			public void onClick(final DialogInterface pDialog, final int pWhich) {
				final T result;
				try {
					result = org.andengine.ui.dialog.GenericInputDialogBuilder.this.generateResult(etInput.getText().toString());
				} catch (final IllegalArgumentException e) {
					Debug.e("Error in GenericInputDialogBuilder.generateResult()", e);
					Toast.makeText(org.andengine.ui.dialog.GenericInputDialogBuilder.this.mContext, org.andengine.ui.dialog.GenericInputDialogBuilder.this.mErrorResID, Toast.LENGTH_SHORT).show();
					return;
				}
				org.andengine.ui.dialog.GenericInputDialogBuilder.this.mSuccessCallback.onCallback(result);
				pDialog.dismiss();
			}
		})
		.setNegativeButton(android.R.string.cancel, new OnClickListener() {
			@Override
			public void onClick(final DialogInterface pDialog, final int pWhich) {
				org.andengine.ui.dialog.GenericInputDialogBuilder.this.mOnCancelListener.onCancel(pDialog);
				pDialog.dismiss();
			}
		});
