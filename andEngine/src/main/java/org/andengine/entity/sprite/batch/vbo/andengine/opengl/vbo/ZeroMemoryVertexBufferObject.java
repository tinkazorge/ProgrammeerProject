...
/**
 * Compared to a {@link org.andengine.opengl.vbo.HighPerformanceVertexBufferObject} or a {@link LowMemoryVertexBufferObject}, the {@link org.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} uses <b><u>no</u> permanent heap memory</b>,
 ...
 * <p/>
 * Usually a {@link org.andengine.opengl.vbo.ZeroMemoryVertexBufferObject} is preferred to a {@link org.andengine.opengl.vbo.HighPerformanceVertexBufferObject} or a {@link LowMemoryVertexBufferObject} when the following conditions are met:
 * <ol>
 * <li>The application is close to run out of memory.</li>
 * <li>You have very big {@link org.andengine.opengl.vbo.HighPerformanceVertexBufferObject}/{@link LowMemoryVertexBufferObject} or an extreme number of small {@link HighPerformanceVertexBufferObject}/{@link LowMemoryVertexBufferObject}s, where you can't afford to have any of the bufferdata to be kept in heap memory.</li>
