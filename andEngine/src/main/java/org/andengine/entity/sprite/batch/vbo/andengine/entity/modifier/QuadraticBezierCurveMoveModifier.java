...
public class QuadraticBezierCurveMoveModifier extends DurationEntityModifier {
	...
	@Override
	public org.andengine.entity.modifier.QuadraticBezierCurveMoveModifier deepCopy() {
		return new org.andengine.entity.modifier.QuadraticBezierCurveMoveModifier(this.mDuration, this.mX1, this.mY1, this.mX2, this.mY2, this.mX3, this.mY3, this.mEaseFunction);
	}
