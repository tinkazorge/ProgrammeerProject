...
public class EaseBackInOut implements IEaseFunction {
	...
	private static org.andengine.util.modifier.ease.EaseBackInOut INSTANCE;
	...
	public static org.andengine.util.modifier.ease.EaseBackInOut getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new org.andengine.util.modifier.ease.EaseBackInOut();
		}
		return INSTANCE;
	}
