package org.andengine.entity.sprite.batch.vbo.andengine.entity.sprite.batch;
...
public class SpriteBatch extends Shape {
	...
	public static final int VERTEX_INDEX_Y = org.andengine.entity.sprite.batch.SpriteBatch.VERTEX_INDEX_X + 1;
	public static final int COLOR_INDEX = org.andengine.entity.sprite.batch.SpriteBatch.VERTEX_INDEX_Y + 1;
	public static final int TEXTURECOORDINATES_INDEX_U = org.andengine.entity.sprite.batch.SpriteBatch.COLOR_INDEX + 1;
	public static final int TEXTURECOORDINATES_INDEX_V = org.andengine.entity.sprite.batch.SpriteBatch.TEXTURECOORDINATES_INDEX_U + 1;

	public static final int VERTEX_SIZE = 2 + 1 + 2;
	public static final int VERTICES_PER_SPRITE = 6;
	public static final int SPRITE_SIZE = org.andengine.entity.sprite.batch.SpriteBatch.VERTEX_SIZE * org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_PER_SPRITE;
	...
	public SpriteBatch(final ITexture pTexture, final int pCapacity, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pTexture, pCapacity, new HighPerformanceSpriteBatchVertexBufferObject(pVertexBufferObjectManager, pCapacity * org.andengine.entity.sprite.batch.SpriteBatch.SPRITE_SIZE, pDrawType, true, org.andengine.entity.sprite.batch.SpriteBatch.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
	...
	public SpriteBatch(final float pX, final float pY, final ITexture pTexture, final int pCapacity, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX, pY, pTexture, pCapacity, new HighPerformanceSpriteBatchVertexBufferObject(pVertexBufferObjectManager, pCapacity * org.andengine.entity.sprite.batch.SpriteBatch.SPRITE_SIZE, pDrawType, true, org.andengine.entity.sprite.batch.SpriteBatch.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
	...
	public SpriteBatch(final ITexture pTexture, final int pCapacity, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType, final ShaderProgram pShaderProgram) {
		this(pTexture, pCapacity, new HighPerformanceSpriteBatchVertexBufferObject(pVertexBufferObjectManager, pCapacity * org.andengine.entity.sprite.batch.SpriteBatch.SPRITE_SIZE, pDrawType, true, org.andengine.entity.sprite.batch.SpriteBatch.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT), pShaderProgram);
	}
	...
	public SpriteBatch(final float pX, final float pY, final ITexture pTexture, final int pCapacity, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType, final ShaderProgram pShaderProgram) {
		this(pX, pY, pTexture, pCapacity, new HighPerformanceSpriteBatchVertexBufferObject(pVertexBufferObjectManager, pCapacity * org.andengine.entity.sprite.batch.SpriteBatch.SPRITE_SIZE, pDrawType, true, org.andengine.entity.sprite.batch.SpriteBatch.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT), pShaderProgram);
	}
	...
	public void setIndex(final int pIndex) {
		...
		final int bufferDataOffset = pIndex * org.andengine.entity.sprite.batch.SpriteBatch.SPRITE_SIZE;
...
//		GLState.enableDepthMask(pGL);
	...
	protected void onSubmit() {
		this.mVertices = this.mIndex * org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_PER_SPRITE;
	...
	protected void add(final ITextureRegion pTextureRegion, final float pX, final float pY, final float pWidth, final float pHeight, final float pRotation, final float pRed, final float pGreen, final float pBlue, final float pAlpha) {
		...
		org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP.setToIdentity();

		org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP.postTranslate(-widthHalf, -heightHalf);
		org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP.postRotate(pRotation);
		org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP.postTranslate(widthHalf, heightHalf);
		org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP.postTranslate(pX, pY);

		this.add(pTextureRegion, pWidth, pHeight, org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP, pRed, pGreen, pBlue, pAlpha);
	}
	...
	protected void addWithPackedColor(final ITextureRegion pTextureRegion, final float pX, final float pY, final float pWidth, final float pHeight, final float pRotation, final float pColorABGRPackedInt) {
		...
		this.addWithPackedColor(pTextureRegion, pWidth, pHeight, org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP, pColorABGRPackedInt);
	}
	...
	protected void add(final ITextureRegion pTextureRegion, final float pX, final float pY, final float pWidth, final float pHeight, final float pScaleX, final float pScaleY, final float pRed, final float pGreen, final float pBlue, final float pAlpha) {
		...
		org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP.postTranslate(-widthHalf, -heightHalf);
		org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP.postScale(pScaleX, pScaleY);
		org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP.postTranslate(widthHalf, heightHalf);
		org.andengine.entity.sprite.batch.SpriteBatch.TRANSFORATION_TMP.postTranslate(pX, pY);
	...
	protected void add(final ITextureRegion pTextureRegion, final float pWidth, final float pHeight, final Transformation pTransformation, final float pRed, final float pGreen, final float pBlue, final float pAlpha) {
		org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[0] = 0;
		org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[1] = 0;

		org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[2] = 0;
		org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[3] = pHeight;

		org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[4] = pWidth;
		org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[5] = 0;

		org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[6] = pWidth;
		org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[7] = pHeight;

		pTransformation.transform(org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP);

		this.addInner(pTextureRegion, org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[0], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[1], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[2], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[3], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[4], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[5], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[6], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[7], pRed, pGreen, pBlue, pAlpha);
	}
	...
	protected void addWithPackedColor(final ITextureRegion pTextureRegion, final float pWidth, final float pHeight, final Transformation pTransformation, final float pColorABGRPackedInt) {
		...
		this.mSpriteBatchVertexBufferObject.addWithPackedColor(pTextureRegion, org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[0], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[1], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[2], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[3], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[4], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[5], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[6], org.andengine.entity.sprite.batch.SpriteBatch.VERTICES_TMP[7], pColorABGRPackedInt);
	}
