...
import org.andengine.util.math.factorioal.IterativeFactorialProvider;
...
public class SparseFactorialCache implements IFactorialProvider {
	...
	private static org.andengine.util.math.factorioal.SparseFactorialCache INSTANCE;
	...
	public static org.andengine.util.math.factorioal.SparseFactorialCache getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new org.andengine.util.math.factorioal.SparseFactorialCache();
		}
		return INSTANCE;
	}
