...
public class SparseByteArray implements Cloneable {
    ...
    @Override
    public org.andengine.util.adt.map.SparseByteArray clone() {
        org.andengine.util.adt.map.SparseByteArray clone = null;
        try {
            clone = (org.andengine.util.adt.map.SparseByteArray) super.clone();
