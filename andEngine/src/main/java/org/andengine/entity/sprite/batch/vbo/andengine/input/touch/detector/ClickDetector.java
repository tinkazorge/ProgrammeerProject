...
public class ClickDetector extends BaseDetector {
	...
	public ClickDetector(final IClickDetectorListener pClickDetectorListener) {
		this(org.andengine.input.touch.detector.ClickDetector.TRIGGER_CLICK_MAXIMUM_MILLISECONDS_DEFAULT, pClickDetectorListener);
	}
	...
	public static interface IClickDetectorListener {
		...
		public void onClick(final org.andengine.input.touch.detector.ClickDetector pClickDetector, final int pPointerID, final float pSceneX, final float pSceneY);
	}
}
