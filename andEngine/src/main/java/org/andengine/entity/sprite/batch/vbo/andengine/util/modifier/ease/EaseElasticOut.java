...
public class EaseElasticOut implements IEaseFunction {
	...
	private static org.andengine.util.modifier.ease.EaseElasticOut INSTANCE;
	...
	public static org.andengine.util.modifier.ease.EaseElasticOut getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new org.andengine.util.modifier.ease.EaseElasticOut();
		}
		return INSTANCE;
	}
	...
	public float getPercentage(final float pSecondsElapsed, final float pDuration) {
		return org.andengine.util.modifier.ease.EaseElasticOut.getValue(pSecondsElapsed, pDuration, pSecondsElapsed / pDuration);
	}
