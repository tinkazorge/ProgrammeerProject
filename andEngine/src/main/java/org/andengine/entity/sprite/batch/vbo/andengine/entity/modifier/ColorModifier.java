...
import org.andengine.entity.modifier.TripleValueSpanEntityModifier;
...
public class ColorModifier extends TripleValueSpanEntityModifier {
	...
	protected ColorModifier(final org.andengine.entity.modifier.ColorModifier pColorModifier) {
		super(pColorModifier);
	}

	@Override
	public org.andengine.entity.modifier.ColorModifier deepCopy() {
		return new org.andengine.entity.modifier.ColorModifier(this);
	}
