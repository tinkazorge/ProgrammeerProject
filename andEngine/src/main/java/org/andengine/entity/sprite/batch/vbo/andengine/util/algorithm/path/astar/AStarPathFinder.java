package org.andengine.entity.sprite.batch.vbo.andengine.util.algorithm.path.astar;
...
import org.andengine.util.algorithm.path.astar.*;
...
public class AStarPathFinder<T> implements IPathFinder<T> {
	...
	@Override
	public Path findPath(final IPathFinderMap<T> pPathFinderMap, final int pXMin, final int pYMin, final int pXMax, final int pYMax, final T pEntity, final int pFromX, final int pFromY, final int pToX, final int pToY, final boolean pAllowDiagonal, final org.andengine.util.algorithm.path.astar.IAStarHeuristic<T> pAStarHeuristic, final ICostFunction<T> pCostFunction) {
	...
	@Override
	public Path findPath(final IPathFinderMap<T> pPathFinderMap, final int pXMin, final int pYMin, final int pXMax, final int pYMax, final T pEntity, final int pFromX, final int pFromY, final int pToX, final int pToY, final boolean pAllowDiagonal, final org.andengine.util.algorithm.path.astar.IAStarHeuristic<T> pAStarHeuristic, final ICostFunction<T> pCostFunction, final float pMaxCost) {
