...
public class AlphaModifier extends SingleValueSpanEntityModifier {
	...
	protected AlphaModifier(final org.andengine.entity.modifier.AlphaModifier pAlphaModifier) {
		super(pAlphaModifier);
	}

	@Override
	public org.andengine.entity.modifier.AlphaModifier deepCopy() {
		return new org.andengine.entity.modifier.AlphaModifier(this);
	}
