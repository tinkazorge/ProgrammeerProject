...
public class SkewXModifier extends SingleValueSpanEntityModifier {
	...
	protected SkewXModifier(final org.andengine.entity.modifier.SkewXModifier pSkewXModifier) {
		super(pSkewXModifier);
	}

	@Override
	public org.andengine.entity.modifier.SkewXModifier deepCopy() {
		return new org.andengine.entity.modifier.SkewXModifier(this);
	}
