...
public class Transformation {
	...
	public final void setTo(final org.andengine.util.adt.transformation.Transformation pTransformation) {
	...
	public final org.andengine.util.adt.transformation.Transformation setToTranslate(final float pX, final float pY) {
		this.a = 1.0f;
		this.b = 0.0f;
		this.c = 0.0f;
		this.d = 1.0f;
	...
	public final org.andengine.util.adt.transformation.Transformation setToRotate(final float pAngle) {
		final float angleRad = MathConstants.DEG_TO_RAD * pAngle;
	...
	public final org.andengine.util.adt.transformation.Transformation setToScale(final float pScaleX, final float pScaleY) {
		this.a = pScaleX;
		this.b = 0.0f;
		this.c = 0.0f;
		this.d = pScaleY;
	...
	public final org.andengine.util.adt.transformation.Transformation setToSkew(final float pSkewX, final float pSkewY) {
		this.a = 1.0f;
	...
	public final void postConcat(final org.andengine.util.adt.transformation.Transformation pTransformation) {
	...
	public final void preConcat(final org.andengine.util.adt.transformation.Transformation pTransformation) {
