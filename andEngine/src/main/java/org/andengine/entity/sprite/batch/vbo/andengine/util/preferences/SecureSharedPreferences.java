...
public class SecureSharedPreferences implements SharedPreferences {
	...
	public SecureSharedPreferences(final SharedPreferences pDelegate, final String pSecureKey, final boolean pEncryptKeys, final boolean pEncryptValues) throws SecureSharedPreferencesException {
		...
		try {
			this.mEncryptCipher = Cipher.getInstance(org.andengine.util.preferences.SecureSharedPreferences.CIPHER_TRANSFORMATION);
			this.mDecryptCipher = Cipher.getInstance(org.andengine.util.preferences.SecureSharedPreferences.CIPHER_TRANSFORMATION);
	...
	protected SecretKeySpec getSecretKeySpec(final String pKey) throws UnsupportedEncodingException, NoSuchAlgorithmException {
		...
		return new SecretKeySpec(keyBytes, org.andengine.util.preferences.SecureSharedPreferences.CIPHER_TRANSFORMATION);
	}

	protected byte[] createKeyBytes(final String pKey) throws UnsupportedEncodingException, NoSuchAlgorithmException {
		final MessageDigest md = MessageDigest.getInstance(org.andengine.util.preferences.SecureSharedPreferences.KEY_HASH_TRANSFORMATION);
		md.reset();
		final byte[] keyBytes = md.digest(pKey.getBytes(org.andengine.util.preferences.SecureSharedPreferences.CHARSET));
		return keyBytes;
	}
	...
	protected String encrypt(final String pPlainText) throws SecureSharedPreferencesException {
		byte[] secureValue;
		try {
			secureValue = org.andengine.util.preferences.SecureSharedPreferences.crypt(this.mEncryptCipher, pPlainText.getBytes(org.andengine.util.preferences.SecureSharedPreferences.CHARSET));
		} catch (final UnsupportedEncodingException e) {
			throw new SecureSharedPreferencesException(e);
		}
	...
	protected String decrypt(final String pCipherText) {
		...
		final byte[] pValue = org.andengine.util.preferences.SecureSharedPreferences.crypt(this.mDecryptCipher, securedValue);
		try {
			return new String(pValue, org.andengine.util.preferences.SecureSharedPreferences.CHARSET);
		} catch (final UnsupportedEncodingException e) {
			throw new SecureSharedPreferencesException(e);
		}
	}
	...
	public class Editor implements SharedPreferences.Editor {
		...
		public Editor() {
			this.mDelegate = org.andengine.util.preferences.SecureSharedPreferences.this.mDelegate.edit();
		}
		...
		public Editor putBoolean(final String pKey, final boolean pValue) {
			final String encryptedKey = org.andengine.util.preferences.SecureSharedPreferences.this.encryptKey(pKey);
			final String encryptedValue = org.andengine.util.preferences.SecureSharedPreferences.this.encryptValue(Boolean.toString(pValue));
		...
		public Editor putInt(final String pKey, final int pValue) {
			final String encryptedKey = org.andengine.util.preferences.SecureSharedPreferences.this.encrypt(pKey);
			final String encryptValue = org.andengine.util.preferences.SecureSharedPreferences.this.encryptValue(Integer.toString(pValue));
		...
		public Editor putLong(final String pKey, final long pValue) {
			final String encryptedKey = org.andengine.util.preferences.SecureSharedPreferences.this.encrypt(pKey);
			final String encryptValue = org.andengine.util.preferences.SecureSharedPreferences.this.encryptValue(Long.toString(pValue));
			this.mDelegate.putString(encryptedKey, encryptValue);
			return this;
		}
		...
		public Editor putFloat(final String pKey, final float pValue) {
			final String encryptedKey = org.andengine.util.preferences.SecureSharedPreferences.this.encrypt(pKey);
			final String encryptedVaue = org.andengine.util.preferences.SecureSharedPreferences.this.encryptValue(Float.toString(pValue));
		...
		public Editor putString(final String pKey, final String pValue) {
			final String encryptedKey = org.andengine.util.preferences.SecureSharedPreferences.this.encrypt(pKey);
			final String encryptValue = org.andengine.util.preferences.SecureSharedPreferences.this.encryptValue(pValue);
			this.mDelegate.putString(encryptedKey, encryptValue);
			return this;
		}
