...
public final class ThreadUtils {
	...
	public static void dumpCurrentThreadInfo() {
		org.andengine.util.ThreadUtils.dumpCurrentThreadInfo(DebugLevel.DEBUG, Thread.currentThread().getStackTrace()[org.andengine.util.ThreadUtils.STACKTRACE_CALLER_DEPTH]);
	}

	public static void dumpCurrentThreadInfo(final DebugLevel pDebugLevel) {
		org.andengine.util.ThreadUtils.dumpCurrentThreadInfo(pDebugLevel, Thread.currentThread().getStackTrace()[org.andengine.util.ThreadUtils.STACKTRACE_CALLER_DEPTH]);
	}
