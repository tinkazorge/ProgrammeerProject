...
public class ProgressMonitor implements IProgressListener {
	...
	private final HashMap<org.andengine.util.progress.ProgressMonitor, IProgressListener> mChildProgressMonitorToProgressListenerMap = new HashMap<org.andengine.util.progress.ProgressMonitor, IProgressListener>();
	...
	public void registerChildProgressMonitor(final org.andengine.util.progress.ProgressMonitor pChildProgressMonitor, final int pChildProgressMonitorRangeFrom, final int pChildProgressMonitorRangeTo) {
		final IProgressListener childProgressMonitorListener = new IProgressListener() {
			...
			public void onProgressChanged(final int pProgress) {
				...
				org.andengine.util.progress.ProgressMonitor.this.onProgressChanged(progress);
			}
		};
	...
	public void unregisterChildProgressMonitor(final org.andengine.util.progress.ProgressMonitor pChildProgressMonitor) {
