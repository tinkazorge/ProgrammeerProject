package org.andengine.entity.sprite.batch.vbo.andengine.entity.scene.menu.animator;

import org.andengine.entity.modifier.MoveModifier;
import org.andengine.entity.scene.menu.MenuScene;
import org.andengine.entity.scene.menu.animator.*;
...
public class SlideMenuSceneAnimator extends MenuSceneAnimator {
	...
	public SlideMenuSceneAnimator() {
		this(org.andengine.entity.scene.menu.animator.SlideMenuSceneAnimator.DIRECTION_DEFAULT, org.andengine.entity.scene.menu.animator.SlideMenuSceneAnimator.EASEFUNCTION_DEFAULT);
	}

	public SlideMenuSceneAnimator(final IEaseFunction pEaseFunction) {
		this(org.andengine.entity.scene.menu.animator.SlideMenuSceneAnimator.DIRECTION_DEFAULT, pEaseFunction);
	}

	public SlideMenuSceneAnimator(final Direction pDirection) {
		this(pDirection, org.andengine.entity.scene.menu.animator.SlideMenuSceneAnimator.EASEFUNCTION_DEFAULT);
	}
	...
	public SlideMenuSceneAnimator(final HorizontalAlign pHorizontalAlign, final VerticalAlign pVerticalAlign) {
		this(pHorizontalAlign, pVerticalAlign, org.andengine.entity.scene.menu.animator.SlideMenuSceneAnimator.DIRECTION_DEFAULT, org.andengine.entity.scene.menu.animator.SlideMenuSceneAnimator.EASEFUNCTION_DEFAULT);
	}
	...
	public SlideMenuSceneAnimator(final HorizontalAlign pHorizontalAlign, final VerticalAlign pVerticalAlign, final IEaseFunction pEaseFunction) {
		this(pHorizontalAlign, pVerticalAlign, org.andengine.entity.scene.menu.animator.SlideMenuSceneAnimator.DIRECTION_DEFAULT, pEaseFunction);
	}
	...
	public SlideMenuSceneAnimator(final HorizontalAlign pHorizontalAlign, final VerticalAlign pVerticalAlign, final Direction pDirection) {
		this(pHorizontalAlign, pVerticalAlign, pDirection, org.andengine.entity.scene.menu.animator.SlideMenuSceneAnimator.EASEFUNCTION_DEFAULT);
	}
	...
	protected void onMenuItemPositionBuilt(final MenuScene pMenuScene, final int pIndex, final IMenuItem pMenuItem, final float pX, final float pY) {
		...
		final MoveModifier moveModifier = new MoveModifier(org.andengine.entity.scene.menu.animator.SlideMenuSceneAnimator.DURATION, fromX, fromY, pX, pY, this.mEaseFunction);
