...
public class LRUCache<K, V> {
	...
	private final GenericPool<LRUCacheValueHolder<K, V>> mLRUCacheValueHolderPool = new GenericPool<org.andengine.util.adt.cache.LRUCache.LRUCacheValueHolder<K, V>>() {
		@Override
...
//		final LRUCacheValueHolder<K, V> lruCacheValueHolder = new LRUCacheValueHolder<K, V>();
	...
	static class LRUCacheQueue<K> {
		...
		private final GenericPool<LRUCacheQueueNode<K>> mLRUCacheQueueNodePool = new GenericPool<org.andengine.util.adt.cache.LRUCache.LRUCacheQueueNode<K>>() {
			@Override
