...
public abstract class Texture implements ITexture {
	...
	protected int mHardwareTextureID = org.andengine.opengl.texture.Texture.HARDWARE_TEXTURE_ID_INVALID;
	 ...
	 * @param pTextureStateListener to be informed when this {@link org.andengine.opengl.texture.Texture} is loaded, unloaded or a {@link ITextureAtlasSource} failed to load.
	 */
	...
	public boolean isLoadedToHardware() {
		return this.mHardwareTextureID != org.andengine.opengl.texture.Texture.HARDWARE_TEXTURE_ID_INVALID;
	}

	@Override
	public void setNotLoadedToHardware() {
		this.mHardwareTextureID = org.andengine.opengl.texture.Texture.HARDWARE_TEXTURE_ID_INVALID;
	}
