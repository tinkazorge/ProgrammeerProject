...
public class FontUtils {
	 ...
	 */
	public static float measureText(final org.andengine.opengl.font.IFont pFont, final CharSequence pText) {
		return org.andengine.opengl.font.FontUtils.measureText(pFont, pText, null);
	}
	 ...
	 * @return the width of pText.
	 */
	public static float measureText(final org.andengine.opengl.font.IFont pFont, final CharSequence pText, final int pStart, final int pEnd) {
		return org.andengine.opengl.font.FontUtils.measureText(pFont, pText, pStart, pEnd, null);
	}
	 ...
	 * @return the width of pText.
	 */
	public static float measureText(final org.andengine.opengl.font.IFont pFont, final CharSequence pText, final float[] pWidths) {
		return org.andengine.opengl.font.FontUtils.measureText(pFont, pText, 0, pText.length(), pWidths);
	}
	 ...
	 * @return the width of pText.
	 */
	public static float measureText(final org.andengine.opengl.font.IFont pFont, final CharSequence pText, final int pStart, final int pEnd, final float[] pWidths) {
	 ...
	 */
	public static int breakText(final org.andengine.opengl.font.IFont pFont, final CharSequence pText, final MeasureDirection pMeasureDirection, final float pWidthMaximum, final float[] pMeasuredWidth) {
	 ...
	 * @return
	 */
	public static <L extends List<CharSequence>> L splitLines(final org.andengine.opengl.font.IFont pFont, final CharSequence pText, final L pResult, final AutoWrap pAutoWrap, final float pAutoWrapWidth) {
		/**
		...
		switch (pAutoWrap) {
			case LETTERS:
				return org.andengine.opengl.font.FontUtils.splitLinesByLetters(pFont, pText, pResult, pAutoWrapWidth);
			case WORDS:
				return org.andengine.opengl.font.FontUtils.splitLinesByWords(pFont, pText, pResult, pAutoWrapWidth);
			case CJK:
				return org.andengine.opengl.font.FontUtils.splitLinesByCJK(pFont, pText, pResult, pAutoWrapWidth);
			case NONE:
			default:
	...
	private static <L extends List<CharSequence>> L splitLinesByLetters(final org.andengine.opengl.font.IFont pFont, final CharSequence pText, final L pResult, final float pAutoWrapWidth) {
...
//				final CharSequence lookaheadLine = pText.subSequence(lineStart, lastNonWhitespace);
				final float lookaheadLineWidth = org.andengine.opengl.font.FontUtils.measureText(pFont, pText, lineStart, lastNonWhitespace);
	...
	private static <L extends List<CharSequence>> L splitLinesByWords(final org.andengine.opengl.font.IFont pFont, final CharSequence pText, final L pResult, final float pAutoWrapWidth) {
		final int textLength = pText.length();
		...
		int lastWordEnd = org.andengine.opengl.font.FontUtils.UNSPECIFIED;
		int lineStart = org.andengine.opengl.font.FontUtils.UNSPECIFIED;
		int lineEnd = org.andengine.opengl.font.FontUtils.UNSPECIFIED;
		...
		while (i < textLength) {
			...
			if (lineStart == org.andengine.opengl.font.FontUtils.UNSPECIFIED) {
				lineStart = wordStart;
			}
...
//			final CharSequence word = pText.subSequence(wordStart, wordEnd);
			...
			final float wordWidth = org.andengine.opengl.font.FontUtils.measureText(pFont, pText, wordStart, wordEnd);
			...
			if (widthNeeded <= lineWidthRemaining) {
				if (firstWordInLine) {
					...
					lineWidthRemaining -= org.andengine.opengl.font.FontUtils.getAdvanceCorrection(pFont, pText, lastWordEnd - 1);
				}
				...
				if (firstWordInLine) {
					...
					lastWordEnd = org.andengine.opengl.font.FontUtils.UNSPECIFIED;
					lineStart = org.andengine.opengl.font.FontUtils.UNSPECIFIED;
					lineEnd = org.andengine.opengl.font.FontUtils.UNSPECIFIED;
				} else {
	...
	private static <L extends List<CharSequence>> L splitLinesByCJK(final org.andengine.opengl.font.IFont pFont, final CharSequence pText, final L pResult, final float pAutoWrapWidth) {
		final int textLength = pText.length();
		...
		while (i < textLength) {
			...
			{ /* Look for a sub string */
				...
				while (i < textLength) {
					...
					final float lineWidth = org.andengine.opengl.font.FontUtils.measureText(pFont, pText, lineStart, lineEnd);
