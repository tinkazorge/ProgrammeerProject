...
public class GLHelper {
	...
	public static Buffer getPixels(final Bitmap pBitmap, final PixelFormat pPixelFormat) {
		return org.andengine.opengl.util.GLHelper.getPixels(pBitmap, pPixelFormat, ByteOrder.nativeOrder());
	}

	public static Buffer getPixels(final Bitmap pBitmap, final PixelFormat pPixelFormat, final ByteOrder pByteOrder) {
		final int[] pixelsARGB_8888 = org.andengine.opengl.util.GLHelper.getPixelsARGB_8888(pBitmap);

		switch (pPixelFormat) {
			case RGB_565:
				return ShortBuffer.wrap(org.andengine.opengl.util.GLHelper.convertARGB_8888toRGB_565(pixelsARGB_8888, pByteOrder)); // TODO Is ShortBuffer or IntBuffer faster?
			case RGBA_8888:
				// HACK =(
				final ByteOrder reverseByteOrder = (pByteOrder == ByteOrder.LITTLE_ENDIAN) ? ByteOrder.BIG_ENDIAN : ByteOrder.LITTLE_ENDIAN;
				return IntBuffer.wrap(org.andengine.opengl.util.GLHelper.convertARGB_8888toRGBA_8888(pixelsARGB_8888, reverseByteOrder));
			case RGBA_4444:
				return ShortBuffer.wrap(org.andengine.opengl.util.GLHelper.convertARGB_8888toRGBA_4444(pixelsARGB_8888, pByteOrder)); // TODO Is ShortBuffer or IntBuffer faster?
			case A_8:
				return ByteBuffer.wrap(org.andengine.opengl.util.GLHelper.convertARGB_8888toA_8(pixelsARGB_8888));
			default:
	...
	public static int[] convertARGB_8888toRGBA_8888(final int[] pPixelsARGB_8888) {
		return org.andengine.opengl.util.GLHelper.convertARGB_8888toRGBA_8888(pPixelsARGB_8888, ByteOrder.nativeOrder());
	}
	...
	public static short[] convertARGB_8888toRGB_565(final int[] pPixelsARGB_8888) {
		return org.andengine.opengl.util.GLHelper.convertARGB_8888toRGB_565(pPixelsARGB_8888, ByteOrder.nativeOrder());
	}
	...
	public static short[] convertARGB_8888toRGBA_4444(final int[] pPixelsARGB_8888) {
		return org.andengine.opengl.util.GLHelper.convertARGB_8888toRGBA_4444(pPixelsARGB_8888, ByteOrder.nativeOrder());
	}
	...
	public static int[] convertRGBA_8888toARGB_8888(final int[] pPixelsRGBA_8888) {
		return org.andengine.opengl.util.GLHelper.convertRGBA_8888toARGB_8888(pPixelsRGBA_8888, ByteOrder.nativeOrder());
	}
	...
	public static int[] convertRGBA_8888toARGB_8888_FlippedVertical(final int[] pPixelsRGBA_8888, final int pWidth, final int pHeight) {
		return org.andengine.opengl.util.GLHelper.convertRGBA_8888toARGB_8888_FlippedVertical(pPixelsRGBA_8888, pWidth, pHeight, ByteOrder.nativeOrder());
	}
