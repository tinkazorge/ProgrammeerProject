...
public class CardinalSplineMoveModifier extends DurationEntityModifier {
	...
	@Override
	public org.andengine.entity.modifier.CardinalSplineMoveModifier deepCopy() {
		return new org.andengine.entity.modifier.CardinalSplineMoveModifier(this.mDuration, this.mCardinalSplineMoveModifierConfig.deepCopy(), this.mEaseFunction);
	}

	public org.andengine.entity.modifier.CardinalSplineMoveModifier reverse() {
		return new org.andengine.entity.modifier.CardinalSplineMoveModifier(this.mDuration, this.mCardinalSplineMoveModifierConfig.deepCopyReverse(), this.mEaseFunction);
	}
