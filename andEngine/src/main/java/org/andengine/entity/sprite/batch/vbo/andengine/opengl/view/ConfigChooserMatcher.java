...
public abstract class ConfigChooserMatcher {
	...
	public static final org.andengine.opengl.view.ConfigChooserMatcher STRICT = new org.andengine.opengl.view.ConfigChooserMatcher() {
		@Override
	...
	public static final org.andengine.opengl.view.ConfigChooserMatcher LOOSE_STENCIL = new org.andengine.opengl.view.ConfigChooserMatcher() {
		@Override
		public boolean matches(final int pRequestedRedSize, final int pRedSize, final int pRequestedGreenSize, final int pGreenSize, final int pRequestedBlueSize, final int pBlueSize, final int pRequestedAlphaSize, final int pAlphaSize, final int pRequestedDepthSize, final int pDepthSize, final int pRequestedStencilSize, final int pStencilSize) {
			if (pDepthSize == pRequestedDepthSize && pStencilSize >= pRequestedStencilSize) {
				if (pRedSize == pRequestedRedSize && pGreenSize == pRequestedGreenSize && pBlueSize == pRequestedBlueSize && pAlphaSize == pRequestedAlphaSize) {
	...
	public static final org.andengine.opengl.view.ConfigChooserMatcher LOOSE_DEPTH_AND_STENCIL = new org.andengine.opengl.view.ConfigChooserMatcher() {
		@Override
		public boolean matches(final int pRequestedRedSize, final int pRedSize, final int pRequestedGreenSize, final int pGreenSize, final int pRequestedBlueSize, final int pBlueSize, final int pRequestedAlphaSize, final int pAlphaSize, final int pRequestedDepthSize, final int pDepthSize, final int pRequestedStencilSize, final int pStencilSize) {
			if (pDepthSize >= pRequestedDepthSize && pStencilSize >= pRequestedStencilSize) {
				if (pRedSize == pRequestedRedSize && pGreenSize == pRequestedGreenSize && pBlueSize == pRequestedBlueSize && pAlphaSize == pRequestedAlphaSize) {
	...
	public static final org.andengine.opengl.view.ConfigChooserMatcher ANY = new org.andengine.opengl.view.ConfigChooserMatcher() {
		@Override
		public boolean matches(final int pRequestedRedSize, final int pRedSize, final int pRequestedGreenSize, final int pGreenSize, final int pRequestedBlueSize, final int pBlueSize, final int pRequestedAlphaSize, final int pAlphaSize, final int pRequestedDepthSize, final int pDepthSize, final int pRequestedStencilSize, final int pStencilSize) {
			return true;
		}
