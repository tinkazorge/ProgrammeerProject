package org.andengine.entity.sprite.batch.vbo.andengine.util.algorithm.hull;

import org.andengine.opengl.util.VertexUtils;
import org.andengine.util.algorithm.hull.*;
...
public class JarvisMarch implements IHullAlgorithm {
	...
	private int jarvisMarch(final float[] pVertices, final int pVertexCount, final int pVertexOffsetX, final int pVertexOffsetY, final int pVertexStride) {
		...
		final int firstHullVertexIndex = org.andengine.util.algorithm.hull.HullUtils.indexOfLowestVertex(pVertices, pVertexCount, pVertexOffsetY, pVertexStride);
