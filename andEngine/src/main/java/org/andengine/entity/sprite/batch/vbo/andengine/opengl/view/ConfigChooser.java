package org.andengine.entity.sprite.batch.vbo.andengine.opengl.view;
...
import org.andengine.opengl.view.*;
import org.andengine.opengl.view.ConfigChooserMatcher;
...
public class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
	...
	public ConfigChooser(final int pRequestedRedSize, final int pRequestedGreenSize, final int pRequestedBlueSize, final int pRequestedAlphaSize, final int pRequestedDepthSize, final int pRequestedStencilSize, final boolean pRequestedMultiSampling) {
		...
		this.mMultiSampleEGLConfig = new int[] {
			...
			EGL10.EGL_RENDERABLE_TYPE, org.andengine.opengl.view.ConfigChooser.EGL_GLES2_BIT,
			EGL10.EGL_SAMPLE_BUFFERS, 1,
			EGL10.EGL_SAMPLES, org.andengine.opengl.view.ConfigChooser.MULTISAMPLE_COUNT,
			EGL10.EGL_NONE
		};
		...
		this.mNvidiaCoverageMultiSampleEGLConfig = new int[] {
			...
			EGL10.EGL_STENCIL_SIZE, pRequestedStencilSize,
			EGL10.EGL_RENDERABLE_TYPE, org.andengine.opengl.view.ConfigChooser.EGL_GLES2_BIT,
			org.andengine.opengl.view.ConfigChooser.EGL_COVERAGE_BUFFERS_NV, 1,
			org.andengine.opengl.view.ConfigChooser.EGL_COVERAGE_SAMPLES_NV, org.andengine.opengl.view.ConfigChooser.MULTISAMPLE_COUNT,
			EGL10.EGL_NONE
		};
	...
	public EGLConfig chooseConfig(final EGL10 pEGL, final EGLDisplay pEGLDisplay) {
		try {
			return this.chooseConfig(pEGL, pEGLDisplay, org.andengine.opengl.view.ConfigChooserMatcher.STRICT);
		} catch (final IllegalArgumentException e) {

		}

		try {
			return this.chooseConfig(pEGL, pEGLDisplay, org.andengine.opengl.view.ConfigChooserMatcher.LOOSE_STENCIL);
		} catch (final IllegalArgumentException e) {

		}

		try {
			return this.chooseConfig(pEGL, pEGLDisplay, org.andengine.opengl.view.ConfigChooserMatcher.LOOSE_DEPTH_AND_STENCIL);
		} catch (final IllegalArgumentException e) {

		}

		return this.chooseConfig(pEGL, pEGLDisplay, org.andengine.opengl.view.ConfigChooserMatcher.ANY);
	}

	private EGLConfig chooseConfig(final EGL10 pEGL, final EGLDisplay pEGLDisplay, final org.andengine.opengl.view.ConfigChooserMatcher pConfigChooserMatcher) throws IllegalArgumentException {
		org.andengine.opengl.view.ConfigChooser.BUFFER[0] = 0;
	...
	private int getEGLConfigCount(final EGL10 pEGL, final EGLDisplay pEGLDisplay, final int[] pEGLConfigAttributes) {
		if (pEGL.eglChooseConfig(pEGLDisplay, pEGLConfigAttributes, null, 0, org.andengine.opengl.view.ConfigChooser.BUFFER) == false) {
			throw new IllegalArgumentException("EGLCONFIG_FALLBACK failed!");
		}
		return org.andengine.opengl.view.ConfigChooser.BUFFER[0];
	}

	private EGLConfig findEGLConfig(final EGL10 pEGL, final EGLDisplay pEGLDisplay, final int[] pEGLConfigAttributes, final int pEGLConfigCount, final org.andengine.opengl.view.ConfigChooserMatcher pConfigChooserMatcher) {
		final EGLConfig[] eglConfigs = new EGLConfig[pEGLConfigCount];
		if (!pEGL.eglChooseConfig(pEGLDisplay, pEGLConfigAttributes, eglConfigs, pEGLConfigCount, org.andengine.opengl.view.ConfigChooser.BUFFER)) {
	...
	private int getConfigAttrib(final EGL10 pEGL, final EGLDisplay pEGLDisplay, final EGLConfig pEGLConfig, final int pAttribute, final int pDefaultValue) {
		if (pEGL.eglGetConfigAttrib(pEGLDisplay, pEGLConfig, pAttribute, org.andengine.opengl.view.ConfigChooser.BUFFER)) {
			return org.andengine.opengl.view.ConfigChooser.BUFFER[0];
		} else {
