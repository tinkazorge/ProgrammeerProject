...
public class ConfigChooserOptions {
	...
	private int mRequestedRedSize = org.andengine.engine.options.ConfigChooserOptions.RED_SIZE_DEFAULT;
	private int mRequestedGreenSize = org.andengine.engine.options.ConfigChooserOptions.GREEN_SIZE_DEFAULT;
	private int mRequestedBlueSize = org.andengine.engine.options.ConfigChooserOptions.BLUE_SIZE_DEFAULT;
	private int mRequestedAlphaSize = org.andengine.engine.options.ConfigChooserOptions.ALPHA_SIZE_DEFAULT;
	private int mRequestedDepthSize = org.andengine.engine.options.ConfigChooserOptions.DEPTH_SIZE_DEFAULT;
	private int mRequestedStencilSize = org.andengine.engine.options.ConfigChooserOptions.STENCIL_SIZE_DEFAULT;
