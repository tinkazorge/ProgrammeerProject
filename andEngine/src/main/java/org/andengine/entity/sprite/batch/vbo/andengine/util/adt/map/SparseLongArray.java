...
public class SparseLongArray implements Cloneable {
    ...
    @Override
    public org.andengine.util.adt.map.SparseLongArray clone() {
        org.andengine.util.adt.map.SparseLongArray clone = null;
        try {
            clone = (org.andengine.util.adt.map.SparseLongArray) super.clone();
