package org.andengine.entity.sprite.batch.vbo.andengine.opengl.texture.atlas.buildable;
...
public interface IBuildableTextureAtlas<S extends ITextureAtlasSource, T extends ITextureAtlas<S>> extends ITextureAtlas<S> {
	 ...
	 * @deprecated Use {@link org.andengine.opengl.texture.atlas.buildable.IBuildableTextureAtlas#addTextureAtlasSource(ITextureAtlasSource)} instead.
	 */
	@Deprecated
	 ...
	 *
	 * @param pTextureAtlasBuilder the {@link ITextureAtlasBuilder} to use for building the {@link ITextureAtlasSource} in this {@link org.andengine.opengl.texture.atlas.buildable.IBuildableTextureAtlas}.
	 * @return itself for method chaining.
	 * @throws TextureAtlasBuilderException i.e. when the {@link ITextureAtlasSource} didn't fit into this {@link org.andengine.opengl.texture.atlas.buildable.IBuildableTextureAtlas}.
	 */
	public org.andengine.opengl.texture.atlas.buildable.IBuildableTextureAtlas<S, T> build(final ITextureAtlasBuilder<S, T> pTextureAtlasBuilder) throws TextureAtlasBuilderException;
}