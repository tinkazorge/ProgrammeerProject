package org.andengine.entity.sprite.batch.vbo.andengine.util.levelstats;
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					final HttpPost httpPost = new HttpPost(org.andengine.util.levelstats.LevelStatsDBConnector.this.mSubmitURL);
					...
					nameValuePairs.add(new BasicNameValuePair("player_id", String.valueOf(org.andengine.util.levelstats.LevelStatsDBConnector.this.mPlayerID)));
					nameValuePairs.add(new BasicNameValuePair("secret", String.valueOf(org.andengine.util.levelstats.LevelStatsDBConnector.this.mSecret)));
