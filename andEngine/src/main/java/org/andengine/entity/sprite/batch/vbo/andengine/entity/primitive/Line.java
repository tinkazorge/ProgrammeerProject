...
public class Line extends Shape {
	...
	public static final int VERTEX_INDEX_Y = org.andengine.entity.primitive.Line.VERTEX_INDEX_X + 1;
	public static final int COLOR_INDEX = org.andengine.entity.primitive.Line.VERTEX_INDEX_Y + 1;

	public static final int VERTEX_SIZE = 2 + 1;
	public static final int VERTICES_PER_LINE = 2;
	public static final int LINE_SIZE = org.andengine.entity.primitive.Line.VERTEX_SIZE * org.andengine.entity.primitive.Line.VERTICES_PER_LINE;
	...
	public Line(final float pX1, final float pY1, final float pX2, final float pY2, final VertexBufferObjectManager pVertexBufferObjectManager) {
		this(pX1, pY1, pX2, pY2, org.andengine.entity.primitive.Line.LINE_WIDTH_DEFAULT, pVertexBufferObjectManager, DrawType.STATIC);
	}
	...
	public Line(final float pX1, final float pY1, final float pX2, final float pY2, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX1, pY1, pX2, pY2, org.andengine.entity.primitive.Line.LINE_WIDTH_DEFAULT, pVertexBufferObjectManager, pDrawType);
	}
	...
	public Line(final float pX1, final float pY1, final float pX2, final float pY2, final float pLineWidth, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX1, pY1, pX2, pY2, pLineWidth, new HighPerformanceLineVertexBufferObject(pVertexBufferObjectManager, org.andengine.entity.primitive.Line.LINE_SIZE, pDrawType, true, org.andengine.entity.primitive.Line.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
	...
	protected void draw(final GLState pGLState, final Camera pCamera) {
		this.mLineVertexBufferObject.draw(GLES20.GL_LINES, org.andengine.entity.primitive.Line.VERTICES_PER_LINE);
	}
	...
	public boolean collidesWith(final IEntity pOtherEntity) {
		if (pOtherEntity instanceof org.andengine.entity.primitive.Line) {
			final org.andengine.entity.primitive.Line otherLine = (org.andengine.entity.primitive.Line) pOtherEntity;
