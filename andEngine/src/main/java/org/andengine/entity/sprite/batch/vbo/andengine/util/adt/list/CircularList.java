package org.andengine.entity.sprite.batch.vbo.andengine.util.adt.list;

import org.andengine.util.adt.list.*;
...
public class CircularList<T> implements IList<T> {
	...
	public CircularList() {
		this(org.andengine.util.adt.list.CircularList.CAPACITY_INITIAL_DEFAULT);
	}
	...
	public int indexOf(final T pItem) {
		...
		return org.andengine.util.adt.list.CircularList.INDEX_INVALID;
	}
