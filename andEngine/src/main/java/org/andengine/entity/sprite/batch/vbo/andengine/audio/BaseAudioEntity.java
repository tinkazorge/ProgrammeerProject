package org.andengine.entity.sprite.batch.vbo.andengine.audio;

import org.andengine.audio.*;
 ...
 */
public abstract class BaseAudioEntity implements org.andengine.audio.IAudioEntity {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	private final IAudioManager<? extends org.andengine.audio.IAudioEntity> mAudioManager;
	...
	public BaseAudioEntity(final IAudioManager<? extends org.andengine.audio.IAudioEntity> pAudioManager) {
