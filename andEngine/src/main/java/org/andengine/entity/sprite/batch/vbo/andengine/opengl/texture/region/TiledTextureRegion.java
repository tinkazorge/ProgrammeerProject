...
public class TiledTextureRegion extends BaseTextureRegion implements ITiledTextureRegion {
	...
	public static org.andengine.opengl.texture.region.TiledTextureRegion create(final ITexture pTexture, final int pTextureX, final int pTextureY, final int pTextureWidth, final int pTextureHeight, final int pTileColumns, final int pTileRows) {
		return org.andengine.opengl.texture.region.TiledTextureRegion.create(pTexture, pTextureX, pTextureY, pTextureWidth, pTextureHeight, pTileColumns, pTileRows, false);
	}

	public static org.andengine.opengl.texture.region.TiledTextureRegion create(final ITexture pTexture, final int pTextureX, final int pTextureY, final int pTextureWidth, final int pTextureHeight, final int pTileColumns, final int pTileRows, final boolean pRotated) {
		...
		return new org.andengine.opengl.texture.region.TiledTextureRegion(pTexture, false, textureRegions);
	}

	@Override
	public org.andengine.opengl.texture.region.TiledTextureRegion deepCopy() {
		...
		return new org.andengine.opengl.texture.region.TiledTextureRegion(this.mTexture, false, textureRegions);
	}
