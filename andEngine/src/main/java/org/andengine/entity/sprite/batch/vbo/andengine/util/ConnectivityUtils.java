...
public final class ConnectivityUtils {
	...
	public static NetworkInfo getNetworkInfo(final Context pContext, final int pNetworkType) {
		return org.andengine.util.ConnectivityUtils.getConnectivityManager(pContext).getNetworkInfo(pNetworkType);
	}
	...
	public static boolean isNetworkAvailable(final Context pContext, final int pNetworkType) {
		return org.andengine.util.ConnectivityUtils.getNetworkInfo(pContext, pNetworkType).isAvailable();
	}
	...
	public static boolean isNetworkConnected(final Context pContext, final int pNetworkType) {
		return org.andengine.util.ConnectivityUtils.getNetworkInfo(pContext, pNetworkType).isConnected();
	}
	...
	public static boolean isNetworkConnectedOrConnecting(final Context pContext, final int pNetworkType) {
		return org.andengine.util.ConnectivityUtils.getNetworkInfo(pContext, pNetworkType).isConnectedOrConnecting();
	}
	...
	public static boolean isEthernetAvailable(final Context pContext) throws ConnectivityUtilsException {
		if (SystemUtils.isAndroidVersionOrHigher(Build.VERSION_CODES.HONEYCOMB_MR2)) {
			return org.andengine.util.ConnectivityUtils.isNetworkAvailable(pContext, ConnectivityManager.TYPE_ETHERNET);
		} else {
	...
	public static boolean isEthernetConnected(final Context pContext) throws ConnectivityUtilsException {
		if (SystemUtils.isAndroidVersionOrHigher(Build.VERSION_CODES.HONEYCOMB_MR2)) {
			return org.andengine.util.ConnectivityUtils.isNetworkConnected(pContext, ConnectivityManager.TYPE_ETHERNET);
		} else {
			throw new ConnectivityUtilsException();
		}
	}
	...
	public static boolean isEthernetConnectedOrConnecting(final Context pContext) throws ConnectivityUtilsException {
		if (SystemUtils.isAndroidVersionOrHigher(Build.VERSION_CODES.HONEYCOMB_MR2)) {
			return org.andengine.util.ConnectivityUtils.isNetworkConnectedOrConnecting(pContext, ConnectivityManager.TYPE_ETHERNET);
		} else {
			throw new ConnectivityUtilsException();
		}
	}
	...
	public static boolean isWifiAvailable(final Context pContext) throws ConnectivityUtilsException {
		return org.andengine.util.ConnectivityUtils.isNetworkAvailable(pContext, ConnectivityManager.TYPE_WIFI);
	}

	public static boolean isWifiConnected(final Context pContext) {
		return org.andengine.util.ConnectivityUtils.isNetworkConnected(pContext, ConnectivityManager.TYPE_WIFI);
	}

	public static boolean isWifiConnectedOrConnecting(final Context pContext) {
		return org.andengine.util.ConnectivityUtils.isNetworkConnectedOrConnecting(pContext, ConnectivityManager.TYPE_WIFI);
	}
