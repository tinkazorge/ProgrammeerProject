...
public class Entity implements IEntity {
	...
	public void detachChildren() {
		...
		this.mChildren.clear(org.andengine.entity.Entity.PARAMETERCALLABLE_DETACHCHILD);
	}
	...
	public boolean detachChild(final IEntity pEntity) {
		...
		return this.mChildren.remove(pEntity, org.andengine.entity.Entity.PARAMETERCALLABLE_DETACHCHILD);
	}
	...
	public IEntity detachChild(final int pTag) {
		...
		for (int i = this.mChildren.size() - 1; i >= 0; i--) {
			if (this.mChildren.get(i).getTag() == pTag) {
				...
				org.andengine.entity.Entity.PARAMETERCALLABLE_DETACHCHILD.call(removed);
				return removed;
			}
		}
		return null;
	...
	public IEntity detachChild(final IEntityMatcher pEntityMatcher) {
		...
		return this.mChildren.remove(pEntityMatcher, org.andengine.entity.Entity.PARAMETERCALLABLE_DETACHCHILD);
	}
	...
	public boolean detachChildren(final IEntityMatcher pEntityMatcher) {
		...
		return this.mChildren.removeAll(pEntityMatcher, org.andengine.entity.Entity.PARAMETERCALLABLE_DETACHCHILD);
	}
	...
	public float[] convertLocalCoordinatesToParentCoordinates(final float pX, final float pY) {
		return this.convertLocalCoordinatesToParentCoordinates(pX, pY, org.andengine.entity.Entity.VERTICES_LOCAL_TO_PARENT_TMP);
	}
	...
	public float[] convertLocalCoordinatesToParentCoordinates(final float[] pCoordinates) {
		return this.convertLocalCoordinatesToParentCoordinates(pCoordinates, org.andengine.entity.Entity.VERTICES_LOCAL_TO_PARENT_TMP);
	}
	...
	public float[] convertParentCoordinatesToLocalCoordinates(final float pX, final float pY) {
		return this.convertParentCoordinatesToLocalCoordinates(pX, pY, org.andengine.entity.Entity.VERTICES_PARENT_TO_LOCAL_TMP);
	}
	...
	public float[] convertParentCoordinatesToLocalCoordinates(final float[] pCoordinates) {
		return this.convertParentCoordinatesToLocalCoordinates(pCoordinates, org.andengine.entity.Entity.VERTICES_PARENT_TO_LOCAL_TMP);
	}
	...
	public float[] convertLocalCoordinatesToSceneCoordinates(final float pX, final float pY) {
		return this.convertLocalCoordinatesToSceneCoordinates(pX, pY, org.andengine.entity.Entity.VERTICES_LOCAL_TO_SCENE_TMP);
	}
	...
	public float[] convertLocalCoordinatesToSceneCoordinates(final float[] pCoordinates) {
		return this.convertLocalCoordinatesToSceneCoordinates(pCoordinates, org.andengine.entity.Entity.VERTICES_LOCAL_TO_SCENE_TMP);
	}
	...
	public float[] convertSceneCoordinatesToLocalCoordinates(final float pX, final float pY) {
		return this.convertSceneCoordinatesToLocalCoordinates(pX, pY, org.andengine.entity.Entity.VERTICES_SCENE_TO_LOCAL_TMP);
	}
	...
	public float[] convertSceneCoordinatesToLocalCoordinates(final float[] pCoordinates) {
		return this.convertSceneCoordinatesToLocalCoordinates(pCoordinates, org.andengine.entity.Entity.VERTICES_SCENE_TO_LOCAL_TMP);
	}
	...
	private void allocateEntityModifiers() {
		this.mEntityModifiers = new EntityModifierList(this, org.andengine.entity.Entity.ENTITYMODIFIERS_CAPACITY_DEFAULT);
	}

	private void allocateChildren() {
		this.mChildren = new SmartList<IEntity>(org.andengine.entity.Entity.CHILDREN_CAPACITY_DEFAULT);
	}

	private void allocateUpdateHandlers() {
		this.mUpdateHandlers = new UpdateHandlerList(org.andengine.entity.Entity.UPDATEHANDLERS_CAPACITY_DEFAULT);
	}
