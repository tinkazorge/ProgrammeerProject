...
public class Sound extends BaseAudioEntity {
	...
	Sound(final org.andengine.audio.sound.SoundManager pSoundManager, final int pSoundID) {
		super(pSoundManager);
	...
	@Override
	protected org.andengine.audio.sound.SoundManager getAudioManager() throws SoundReleasedException {
