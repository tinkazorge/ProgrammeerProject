package org.andengine.entity.sprite.batch.vbo.andengine.util.adt.trie;
	...
	public static class TrieNode implements ITrie {
		...
		public void add(final CharSequence pCharSequence, final int pStart, final int pEnd) {
			if (this.mChildren == null) {
				this.mChildren = new SparseArray<org.andengine.util.adt.trie.Trie.TrieNode>(org.andengine.util.adt.trie.Trie.CHILDREN_SIZE_DEFAULT);
			}
