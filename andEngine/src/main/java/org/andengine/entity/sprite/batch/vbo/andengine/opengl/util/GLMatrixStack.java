package org.andengine.entity.sprite.batch.vbo.andengine.opengl.util;
...
public class GLMatrixStack {
	...
	private static final int GLMATRIXSTACKOFFSET_UNDERFLOW = -1 * org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE;
	private static final int GLMATRIXSTACKOFFSET_OVERFLOW = org.andengine.opengl.util.GLMatrixStack.GLMATRIXSTACK_DEPTH_MAX * org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE;

	// ===========================================================
	// Fields
	// ===========================================================

	final float[] mMatrixStack = new float[org.andengine.opengl.util.GLMatrixStack.GLMATRIXSTACK_DEPTH_MAX * org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE];
	int mMatrixStackOffset;

	private final float[] mTemp = new float[2 * org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE];
	...
	public void getMatrix(final float[] pMatrix) {
		if (this.mMatrixStackOffset - org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE <= org.andengine.opengl.util.GLMatrixStack.GLMATRIXSTACKOFFSET_UNDERFLOW) {
			throw new GLMatrixStackUnderflowException();
		}

		System.arraycopy(this.mMatrixStack, this.mMatrixStackOffset, pMatrix, 0, org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE);
	}
	...
	public void glRotatef(final float pAngle, final float pX, final float pY, final float pZ) {
		...
		System.arraycopy(this.mMatrixStack, this.mMatrixStackOffset, this.mTemp, org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE, org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE);
		Matrix.multiplyMM(this.mMatrixStack, this.mMatrixStackOffset, this.mTemp, org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE, this.mTemp, 0);
	}
	...
	public void glSkewf(final float pSkewX, final float pSkewY) {
		org.andengine.opengl.util.GLMatrixStack.setSkewM(this.mTemp, 0, pSkewX, pSkewY);
		System.arraycopy(this.mMatrixStack, this.mMatrixStackOffset, this.mTemp, org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE, org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE);
		Matrix.multiplyMM(this.mMatrixStack, this.mMatrixStackOffset, this.mTemp, org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE, this.mTemp, 0);
	}
	...
	public void glPushMatrix() throws GLMatrixStackOverflowException {
		if (this.mMatrixStackOffset + org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE >= org.andengine.opengl.util.GLMatrixStack.GLMATRIXSTACKOFFSET_OVERFLOW) {
			throw new GLMatrixStackOverflowException();
		}

		System.arraycopy(this.mMatrixStack, this.mMatrixStackOffset, this.mMatrixStack, this.mMatrixStackOffset + org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE, org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE);
		this.mMatrixStackOffset += org.andengine.opengl.util.GLMatrixStack.GLMATRIX_SIZE;
	}
