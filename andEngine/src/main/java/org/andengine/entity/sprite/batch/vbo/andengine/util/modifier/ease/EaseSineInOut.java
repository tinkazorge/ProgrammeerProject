...
public class EaseSineInOut implements IEaseFunction {
	...
	private static org.andengine.util.modifier.ease.EaseSineInOut INSTANCE;
	...
	public static org.andengine.util.modifier.ease.EaseSineInOut getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new org.andengine.util.modifier.ease.EaseSineInOut();
		}
		return INSTANCE;
	}
