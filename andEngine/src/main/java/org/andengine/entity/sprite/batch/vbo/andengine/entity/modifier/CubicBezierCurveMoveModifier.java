...
public class CubicBezierCurveMoveModifier extends DurationEntityModifier {
	...
	@Override
	public org.andengine.entity.modifier.CubicBezierCurveMoveModifier deepCopy() {
		return new org.andengine.entity.modifier.CubicBezierCurveMoveModifier(this.mDuration, this.mX1, this.mY1, this.mX2, this.mY2, this.mX3, this.mY3, this.mX4, this.mY4, this.mEaseFunction);
	}
