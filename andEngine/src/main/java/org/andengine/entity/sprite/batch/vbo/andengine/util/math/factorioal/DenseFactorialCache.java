...
public class DenseFactorialCache implements IFactorialProvider {
	...
	private static org.andengine.util.math.factorioal.DenseFactorialCache INSTANCE;
	...
	public static org.andengine.util.math.factorioal.DenseFactorialCache getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new org.andengine.util.math.factorioal.DenseFactorialCache();
		}
		return INSTANCE;
	}
