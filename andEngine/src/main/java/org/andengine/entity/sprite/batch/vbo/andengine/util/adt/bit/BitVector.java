 ...
 * @author ngramlich
 */
public abstract class BitVector implements org.andengine.util.adt.bit.IBitVector {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public static org.andengine.util.adt.bit.IBitVector wrap(final byte[] pData) {
		return new ByteBackedBitVector(pData);
	}

	public static org.andengine.util.adt.bit.IBitVector wrap(final int pSize, final byte[] pData) {
		return new ByteBackedBitVector(pData);
	}

	public static org.andengine.util.adt.bit.IBitVector wrap(final long[] pData) {
	...
	public static int getBitInByte(final byte pByte, final int pIndex) throws IllegalArgumentException {
		return org.andengine.util.adt.bit.BitVector.getBitsInByte(pByte, pIndex, 1);
	}
	...
	public static int calculateByteSize(final int pBitSize) {
		...
		if (org.andengine.util.adt.bit.BitVector.getIndexInByte(pBitSize) == 0) {
	...
	public static int calculateLongSize(final int pBitSize) {
		...
		if (org.andengine.util.adt.bit.BitVector.getIndexInLong(pBitSize) == 0) {
			return pBitSize / Byte.SIZE;
		} else {
			return 1 + (pBitSize / Byte.SIZE);
		}
