...
public class MultiKey<K> {
	...
	public MultiKey(final K... pKeys) {
		...
		this.mCachedHashCode = org.andengine.util.adt.map.MultiKey.hash(pKeys);
	}
	...
	public boolean equals(final Object pOther) {
		...
		if (pOther instanceof org.andengine.util.adt.map.MultiKey<?>) {
			final org.andengine.util.adt.map.MultiKey<?> otherMultiKey = (org.andengine.util.adt.map.MultiKey<?>) pOther;
