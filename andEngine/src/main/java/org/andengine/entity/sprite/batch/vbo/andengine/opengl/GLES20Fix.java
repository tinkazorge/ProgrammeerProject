package org.andengine.entity.sprite.batch.vbo.andengine.opengl;
...
public class GLES20Fix {
	...
	public static void glVertexAttribPointerFix(final int pIndex, final int pSize, final int pType, final boolean pNormalized, final int pStride, final int pOffset) {
		if (org.andengine.opengl.GLES20Fix.WORKAROUND_MISSING_GLES20_METHODS) {
			org.andengine.opengl.GLES20Fix.glVertexAttribPointerFix(pIndex, pSize, pType, pNormalized, pStride, pOffset);
		} else {
	...
	public static void glDrawElementsFix(final int pMode, final int pCount, final int pType, final int pOffset) {
		if (org.andengine.opengl.GLES20Fix.WORKAROUND_MISSING_GLES20_METHODS) {
			org.andengine.opengl.GLES20Fix.glDrawElements(pMode, pCount, pType, pOffset);
		} else {
