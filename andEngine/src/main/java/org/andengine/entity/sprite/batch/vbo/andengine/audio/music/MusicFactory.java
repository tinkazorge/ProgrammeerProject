package org.andengine.entity.sprite.batch.vbo.andengine.audio.music;
...
public final class MusicFactory {
	...
	public static void setAssetBasePath(final String pAssetBasePath) {
		if (pAssetBasePath.endsWith("/") || pAssetBasePath.length() == 0) {
			org.andengine.audio.music.MusicFactory.sAssetBasePath = pAssetBasePath;
		} else {
	...
	public static String getAssetBasePath() {
		return org.andengine.audio.music.MusicFactory.sAssetBasePath;
	}

	public static void onCreate() {
		org.andengine.audio.music.MusicFactory.setAssetBasePath("");
	}
	...
	public static Music createMusicFromAsset(final MusicManager pMusicManager, final Context pContext, final String pAssetPath) throws IOException {
		...
		final AssetFileDescriptor assetFileDescritor = pContext.getAssets().openFd(org.andengine.audio.music.MusicFactory.sAssetBasePath + pAssetPath);
