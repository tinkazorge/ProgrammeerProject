 ...
 */
public class LongBackedBitVector extends org.andengine.util.adt.bit.BitVector {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public LongBackedBitVector(final int pSize, final long[] pData) throws IllegalArgumentException {
		...
		if (org.andengine.util.adt.bit.BitVector.calculateLongSize(pSize) < pData.length) {
	...
	public LongBackedBitVector(final DataInputStream pDataInputStream) throws IOException {
		...
		this.mData = new long[org.andengine.util.adt.bit.BitVector.calculateLongSize(this.mSize)];
...
//		pDataInputStream.readFully(this.mData);
	...
	public static org.andengine.util.adt.bit.LongBackedBitVector load(final DataInputStream pDataInputStream) throws IOException {
		return new org.andengine.util.adt.bit.LongBackedBitVector(pDataInputStream);
	}
