...
public class SpriteGroup extends DynamicSpriteBatch {
	...
	public void attachChild(final IEntity pEntity) throws IllegalArgumentException {
		if (pEntity instanceof Sprite) {
			...
			throw new IllegalArgumentException("A " + org.andengine.entity.sprite.batch.SpriteGroup.class.getSimpleName() + " can only handle children of type Sprite or subclasses of Sprite, like TiledSprite or AnimatedSprite.");
		}
	}
	...
	private void assertCapacity() {
		if (this.getChildCount() >= this.mCapacity) {
			throw new IllegalStateException("This " + org.andengine.entity.sprite.batch.SpriteGroup.class.getSimpleName() + " has already reached its capacity (" + this.mCapacity + ") !");
		}
	}
