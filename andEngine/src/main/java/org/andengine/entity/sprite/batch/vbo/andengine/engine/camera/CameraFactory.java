...
public final class CameraFactory {
	...
	public static org.andengine.engine.camera.Camera createPixelPerfectCamera(final Context pContext, final float pCenterX, final float pCenterY) {
		final DisplayMetrics displayMetrics = org.andengine.engine.camera.CameraFactory.getDisplayMetrics(pContext);
